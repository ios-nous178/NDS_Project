...
grid:
  ...
  desktop:
    ...
    margin: 360px
    gutter: 24px
    contentWidth: 1200px # 1920 - 360*2
...
| 컬럼 수     | 4               | 12           |
| 좌우 마진   | 16px            | 360px (auto) |
| 거터        | 8px             | 24px         |
| 콘텐츠 너비 | 328px           | 1200px       |

- **Mobile**: 기준 뷰포트 360px(Android). 좌우 마진 16px 고정, 콘텐츠 328px. iOS(375px)에서도 마진 16px 유지, 콘텐츠 영역이 자연스럽게 확장.
- **Desktop**: 12컬럼 그리드, 거터 24px. 콘텐츠 최대 1200px 중앙 정렬. 컬럼 간 자유로운 span 조합 가능 (3+9, 6+6, 4+4+4, 3+6+3 등).
