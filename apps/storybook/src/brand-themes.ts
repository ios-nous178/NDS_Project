 ...
 * 컴포넌트 레벨(--nds-*) 토큰도 brand theme 의 `components` 블록이 dist css 로 emit 한다.
 *
 * **cssVars 는 비어 있어야 정상** — 값은 packages/tokens/src/brands/* 가 SSOT 다.
...
/** 브랜드 메타만 정의 — cssVars 는 빈 객체 유지 (값 SSOT 는 packages/tokens/src/brands/*). */
