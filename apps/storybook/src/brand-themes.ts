...
export const brandThemes: Record<string, BrandTheme> = {
  ...
  moneple: {
    name: "moneple",
    label: "Moneple (모네플)",
    description: "테넌트 컬러 기반 커뮤니티 플랫폼. 기본값은 Moneple05 홈 목업 기준",
    cssImport: "moneple",
    cssVars: {
      // ── Mock color palette: Moneple05 community-home colors ──
      "--semantic-primary-main": "#FFF42E",
      "--semantic-primary-hover": "#FFE52E",
      "--semantic-primary-pressed": "#E6D200",
      "--semantic-primary-lighter": "#FFF8B8",
      "--semantic-primary-bg": "#FFFCE4",
      "--semantic-primary-bgLighter": "#FFFCE4",
      "--semantic-primary-fg": "#333333",
      "--semantic-secondary-sub": "#4968FF",
      "--semantic-secondary-lighter": "#A3B3FF",
      "--semantic-secondary-bg": "#EDF0FF",
      "--semantic-secondary-bgLighter": "#F6F7FF",
      ...
      "--semantic-success-main": "#00BC78",
      "--semantic-text-default": "#333333",
      "--semantic-text-subtle": "#666666",
      "--semantic-border-default": "#EDEDED",
      "--semantic-border-focus": "#4968FF",
      "--semantic-bg-coolGray": "#F4F4F4",
      "--semantic-bg-overlay": "rgba(0, 0, 0, 0.5)",

      // ── Component-level shape overrides from Moneple ──
      "--nds-button-background": "#FFF42E",
      "--nds-button-text-color": "#333333",
      "--nds-button-border-color": "#FFF42E",
      "--nds-button-radius": "6px",
      "--nds-button-hover-background": "#FFE52E",

      "--nds-input-border-color": "#EDEDED",
      "--nds-badge-background": "#F4F4F4",
      "--nds-badge-text-color": "#666666",
      "--nds-card-radius": "8px",
      "--nds-card-border-color": "#EDEDED",

      "--font-web":
        "'Pretendard', -apple-system, BlinkMacSystemFont, 'Malgun Gothic', Roboto, Helvetica, Arial, sans-serif, system-ui",
      ...
      "--nds-app-bar-search-border-color": "#FFF42E",
      "--nds-app-bar-search-border-width": "1px",
      "--nds-app-bar-search-radius": "20px",
      "--nds-app-bar-gnb-font-size": "16px",
      "--nds-app-bar-gnb-active-color": "#333333",
      "--nds-app-bar-gnb-inactive-color": "#999999",
      "--nds-app-bar-gnb-active-border-width": "2px",
      "--nds-app-bar-auth-font-size": "14px",
      "--nds-app-bar-auth-font-weight": "500",
      ...
      "--nds-toast-font-weight": "500",
      "--nds-toast-max-width": "300px",
      "--nds-toast-shadow": "0px 4px 12px rgba(0,0,0,0.12)",
      ...
      "--nds-chip-selected-text": "#FFFFFF",
      "--nds-chip-selected-border": "#333333",
      "--nds-chip-border": "#EDEDED",
      "--nds-chip-text": "#666666",
      "--nds-chip-font-size": "14px",
      "--nds-chip-font-weight": "500",
