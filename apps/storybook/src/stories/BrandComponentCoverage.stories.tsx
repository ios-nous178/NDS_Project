...
/* ─── React 패키지 export 매니페스트 (packages/react/src/index.ts 기준) ─── */
const REACT_EXPORTS: ReadonlySet<string> = new Set([
  "Accordion",
  "Asset",
  "Button",
  "TextButton",
...
/* ─── HTML 패키지 export 매니페스트 (packages/html/src/index.ts 기준) ─── */
const HTML_EXPORTS: ReadonlySet<string> = new Set([
  "Button",
  "IconButton",
  "Avatar",
  "Badge",
...
/* ─── 브랜드 chrome 별도 매니페스트 (packages/react/src/{brand}/*.tsx 기준) ─── */
const BRAND_CHROME: Record<Brand, ReadonlySet<string>> = {
  trost: new Set([
    "AppBar",
    "Footer",
    "BottomNav",
  ...
  geniet: new Set(["AppBar", "Footer", "BottomNav"]),
  "nudge-eap": new Set(["AppBar", "Footer", "BottomNav", "WebHeader", "Logo"]),
  "cashwalk-biz": new Set(["Footer", "WebHeader"]),
};
