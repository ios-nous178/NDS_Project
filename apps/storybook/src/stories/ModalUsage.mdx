import { Meta, Canvas, Controls, Source, Subtitle, Title } from "@storybook/addon-docs/blocks";
...
<Subtitle>
  복붙 가능한 예제로 Modal의 flat, compound, slotProps, className 패턴을 비교합니다.
</Subtitle>

> ✅ **Figma 가이드 정합 완료** (2026-05-12) — Figma `612:18421` / 라이브러리 `171:9947` 기준 콘텐츠 너비, 패딩, 푸터 버튼 스펙이 코드와 일치합니다. 자세한 스펙은 `Components/Modal → Spec/✓ Figma Synced` 스토리에서 확인하세요.
...
bodyClassName="webview-playlist-edit-modal-class\_\_body"
