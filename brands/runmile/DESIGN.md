...
note: |
  ...
  미러이며, 토큰 코드는 packages/tokens/src/brands/runmile.palette.ts /
...
- 토큰 코드: `packages/tokens/src/brands/runmile.{palette,semantic}.ts`
...
| Token        | Hex       | 용도                                 |
| ------------ | --------- | ------------------------------------ |
| `orange/100` | `#FFF7F5` | brand subtle bg, info bg             |
| `orange/200` | `#FFF0ED` | hover bg                             |
| `orange/300` | `#FECDC1` | disabled brand                       |
| `orange/400` | `#FF805C` | 보조 강조                            |
| `orange/500` | `#FF5B37` | **brand primary** — CTA, focus, link |
