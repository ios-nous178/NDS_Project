...
- **브랜드 톤**: 따뜻하고 조용히 안심을 주는 톤. 비임상적이고 친근한 언어
...
- **Card shadow**: `0 2px 16px rgba(0,0,0,0.12)` — 소프트 드롭 섀도우
...
- **한국어 우선** (`lang="ko"`). 영문은 법률/푸터 보일러플레이트, 브랜드명에만 사용
...
- 홈 레벨에서 다른 앱의 이모지/플랫 아이콘 역할을 대체하는 핵심 브랜드 에셋
