...
- 인벤토리 생성 스크립트: `scripts/generate-component-inventory.mjs`
- 자동 생성 문서: `docs/components/inventory.md`
...
2. `node-id`를 함께 기록
3. `metadata/componentInventory.json`의 해당 컴포넌트 항목에 입력
4. `pnpm generate:component-inventory` 실행
5. Storybook Docs와 컴포넌트 인벤토리에서 확인
