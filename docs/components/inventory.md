...
| **Badge**           | 상태, 카테고리, 라벨을 짧게 표시하는 배지. fill/ghost/line × brand/neutral/success/error/caution/info 매트릭스. | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-10856) (171:10856)               | [열기](http://localhost:6006/?path=/docs/components-badge--docs)           | [열기](http://localhost:3001/docs/components/badge)            | 상태 표시, 카테고리 태그, 보조 라벨                               |
...
| **Checkbox**         | 다중/독립 항목 토글 체크박스. 20×20px, 4px radius, fillBrand 활성, indeterminate(부분 선택) 지원.                         | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-9904) (171:9904)                 | [열기](http://localhost:6006/?path=/docs/components-checkbox-radio--docs)   | [열기](http://localhost:3001/docs/components/checkbox-radio)    | 약관 동의, 다중 필터, 설정 다중 선택, 부모/자식 부분 선택    |
| **Chip**             | 선택/삭제 가능한 태그 컴포넌트. fill(선택됨) / outlined(선택 가능) / ghost(비활성) × brand/neutral/success/error/caution. | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-10856) (171:10856)               | [열기](http://localhost:6006/?path=/docs/components-chip--docs)             | [열기](http://localhost:3001/docs/components/chip)              | 필터 태그, 카테고리 선택, 상담 주제 선택, 키워드 태그        |
...
| **Radio**            | 단일 선택 라디오 버튼. 20×20px, 2px borderNormal, 10px 내부 원(fillBrand). RadioGroup vertical/horizontal 레이아웃.       | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-9904) (171:9904)                 | [열기](http://localhost:6006/?path=/docs/components-radio--docs)            | [열기](http://localhost:3001/docs/components/checkbox-radio)    | 성별, 상담 유형, 단일 선택 폼 항목, 설문 단일 응답           |
| **Toggle**           | On/Off 스위치. md: 44×24 track, 18px thumb. Off=borderNormal, On=fillBrand. thumb 0.2s 슬라이드 애니메이션.               | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-9904) (171:9904)                 | [열기](http://localhost:6006/?path=/docs/components-toggle--docs)           | [열기](http://localhost:3001/docs/components/toggle)            | 알림 설정, CMS 기능 활성화, 즉시 반영 On/Off                 |
...
| 컴포넌트       | 설명                                                                                                                     | 상태      | Figma                                                                                    | Storybook                                                             | Docs                                                     | 활용 범위                                                |
| -------------- | ------------------------------------------------------------------------------------------------------------------------ | --------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| **Tabs**       | 동일 계층 콘텐츠 전환용 탭 컴포넌트. Line · Chip · Segment 3가지 유형과 Neutral/Color 톤, Mobile/PC 사이즈를 지원합니다. | ✅ 구현됨 | [열기](https://www.figma.com/design/MqR7O3uvBvH5tVngwzbqGH/?node-id=171-9902) (171:9902) | [열기](http://localhost:6006/?path=/docs/components-tabs--docs)       | [열기](http://localhost:3001/docs/components/tabs)       | 콘텐츠 전환, 카테고리 필터, CMS 페이지 분할              |
