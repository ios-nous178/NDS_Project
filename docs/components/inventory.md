...
| **Checkbox**         | 다중/독립 항목 토글. 20×20px, 2px borderNormal, indeterminate(부분 선택) 지원                         | ✅ 구현됨 | ✅ 동기화                                                                                                | [열기](http://localhost:6006/?path=/docs/components-checkbox-radio--docs)   | [열기](http://localhost:3001/docs/components/checkbox-radio)    | 약관 동의, 다중 필터, 부모/자식 부분 선택                    |
...
| **Radio**            | 단일 선택 라디오. 20×20px, 2px borderNormal + 10px 내부 원(fillBrand). RadioGroup vertical/horizontal | ✅ 구현됨 | ✅ 동기화                                                                                                | [열기](http://localhost:6006/?path=/docs/components-radio--docs)            | [열기](http://localhost:3001/docs/components/radio)             | 성별, 상담 유형, 단일 선택 폼 항목, 설문 단일 응답           |
| **Toggle**           | On/Off 스위치. md=44×24 track + 18px thumb. Off=borderNormal, On=fillBrand. 0.2s 슬라이드             | ✅ 구현됨 | ✅ 동기화                                                                                                | [열기](http://localhost:6006/?path=/docs/components-toggle--docs)           | [열기](http://localhost:3001/docs/components/toggle)            | 알림 설정, CMS 기능 활성화, 즉시 반영 On/Off                 |
