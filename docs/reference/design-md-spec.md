...
이 문서는 `AGENTS.md`와 `README.md`의 디자인 측면 대응물 역할을 합니다. README 파일이 프로젝트 개요를 문서화하고 AGENTS.md가 코딩 에이전트를 안내하는 반면, `DESIGN.md`는 **디자인 에이전트**에게 **프로젝트가 어떻게 보이고 느껴져야 하는지**를 지시합니다.
