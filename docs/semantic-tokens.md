...
| CSS 변수                       | JS 참조                | NudgeEAP  | Trost     | Moneple   | 가이드          |
| ------------------------------ | ---------------------- | --------- | --------- | --------- | --------------- |
| `--semantic-primary-main`      | `cv.primary.main`      | `#2B96ED` | `#FFF42E` | `#FFF42E` | 🟦 core (222:2) |
| `--semantic-primary-hover`     | `cv.primary.hover`     | `#017EE4` | `#FFE600` | `#FFE52E` | 🟦 core (222:2) |
| `--semantic-primary-pressed`   | `cv.primary.pressed`   | `#1B65BA` | `#E6D200` | `#E6D200` | 🟦 core (222:2) |
| `--semantic-primary-lighter`   | `cv.primary.lighter`   | `#91CAF6` | `#FFF8B8` | `#FFF8B8` |                 |
| `--semantic-primary-bg`        | `cv.primary.bg`        | `#E3F2FC` | `#FFF8B8` | `#FFFCE4` | 🟦 core (222:2) |
| `--semantic-primary-bgLighter` | `cv.primary.bgLighter` | `#F1F8FD` | `#FFFCE6` | `#FFFCE4` | 🟦 core (222:2) |
| `--semantic-primary-fg`        | `cv.primary.fg`        | `#FFFFFF` | `#000000` | `#333333` |                 |

## Palette · Secondary

| CSS 변수                         | JS 참조                  | NudgeEAP  | Trost     | Moneple   | 가이드          |
| -------------------------------- | ------------------------ | --------- | --------- | --------- | --------------- |
| `--semantic-secondary-sub`       | `cv.secondary.sub`       | `#ED2E77` | `#4968FF` | `#4968FF` | 🟦 core (222:2) |
| `--semantic-secondary-lighter`   | `cv.secondary.lighter`   | `#F8B8CF` | `#A3B3FF` | `#A3B3FF` |                 |
| `--semantic-secondary-bg`        | `cv.secondary.bg`        | `#FCE3EC` | `#EDF0FF` | `#EDF0FF` |                 |
| `--semantic-secondary-bgLighter` | `cv.secondary.bgLighter` | `#FDF1F5` | `#F6F7FF` | `#F6F7FF` |                 |

## Palette · Error

| CSS 변수                | JS 참조         | NudgeEAP  | Trost     | Moneple   | 가이드          |
| ----------------------- | --------------- | --------- | --------- | --------- | --------------- |
| `--semantic-error-main` | `cv.error.main` | `#F13F00` | `#FF4111` | `#FF4111` | 🟦 core (222:2) |
| `--semantic-error-bg`   | `cv.error.bg`   | `#FEE9E6` | `#FEE9E6` | `#FEE9E6` | 🟦 core (222:2) |

## Palette · Caution

| CSS 변수                  | JS 참조           | NudgeEAP  | Trost     | Moneple   | 가이드          |
| ------------------------- | ----------------- | --------- | --------- | --------- | --------------- |
| `--semantic-caution-main` | `cv.caution.main` | `#FFC303` | `#FF9D00` | `#FF9D00` | 🟦 core (222:2) |
| `--semantic-caution-text` | `cv.caution.text` | `#FFA100` | `#FF9D00` | `#FF9D00` |                 |
| `--semantic-caution-bg`   | `cv.caution.bg`   | `#FFFAE8` | `#FFF8E6` | `#FFF8E6` | 🟦 core (222:2) |

## Palette · Success

| CSS 변수                  | JS 참조           | NudgeEAP  | Trost     | Moneple   | 가이드          |
| ------------------------- | ----------------- | --------- | --------- | --------- | --------------- |
| `--semantic-success-main` | `cv.success.main` | `#13BFA2` | `#00BC78` | `#00BC78` | 🟦 core (222:2) |
| `--semantic-success-bg`   | `cv.success.bg`   | `#E5F7F4` | `#E6F9F2` | `#E6F9F2` | 🟦 core (222:2) |

## Palette · Text

| CSS 변수                      | JS 참조               | NudgeEAP  | Trost     | Moneple   | 가이드 |
| ----------------------------- | --------------------- | --------- | --------- | --------- | ------ |
| `--semantic-text-strong`      | `cv.text.strong`      | `#000000` | `#000000` | `#000000` |        |
| `--semantic-text-normal`      | `cv.text.normal`      | `#111111` | `#333333` | `#333333` |        |
| `--semantic-text-default`     | `cv.text.default`     | `#383838` | `#333333` | `#333333` |        |
| `--semantic-text-subtle`      | `cv.text.subtle`      | `#666666` | `#606060` | `#666666` |        |
| `--semantic-text-disabled`    | `cv.text.disabled`    | `#999999` | `#979797` | `#BBBBBB` |        |
| `--semantic-text-placeholder` | `cv.text.placeholder` | `#999999` | `#979797` | `#999999` |        |
| `--semantic-text-inverse`     | `cv.text.inverse`     | `#FFFFFF` | `#FFFFFF` | `#FFFFFF` |        |

## Palette · Background

| CSS 변수                        | JS 참조                 | NudgeEAP          | Trost                | Moneple              | 가이드 |
| ------------------------------- | ----------------------- | ----------------- | -------------------- | -------------------- | ------ |
| `--semantic-bg-white`           | `cv.bg.white`           | `#FFFFFF`         | `#FFFFFF`            | `#FFFFFF`            |        |
| `--semantic-bg-light`           | `cv.bg.light`           | `#FAFAFA`         | `#F6F6F6`            | `#F5F5F5`            |        |
| `--semantic-bg-coolGray`        | `cv.bg.coolGray`        | `#F3F4F6`         | `#F4F5F7`            | `#F4F4F4`            |        |
| `--semantic-bg-coolGrayLighter` | `cv.bg.coolGrayLighter` | `#F8F9FB`         | `#F2F2F2`            | `#F4F4F4`            |        |
| `--semantic-bg-disabled`        | `cv.bg.disabled`        | `#ECECEC`         | `#E5E5E5`            | `#EDEDED`            |        |
| `--semantic-bg-overlay`         | `cv.bg.overlay`         | `rgba(0,0,0,0.5)` | `rgba(0, 0, 0, 0.7)` | `rgba(0, 0, 0, 0.5)` |        |

## Palette · Border

| CSS 변수                     | JS 참조              | NudgeEAP  | Trost     | Moneple   | 가이드 |
| ---------------------------- | -------------------- | --------- | --------- | --------- | ------ |
| `--semantic-border-default`  | `cv.border.default`  | `#D8D8D8` | `#E5E5E5` | `#EDEDED` |        |
| `--semantic-border-light`    | `cv.border.light`    | `#ECECEC` | `#F2F2F2` | `#F4F4F4` |        |
| `--semantic-border-focus`    | `cv.border.focus`    | `#2B96ED` | `#4968FF` | `#4968FF` |        |
| `--semantic-border-disabled` | `cv.border.disabled` | `#ECECEC` | `#E5E5E5` | `#EDEDED` |        |

## Palette · Icon

| CSS 변수                  | JS 참조           | NudgeEAP  | Trost     | Moneple   | 가이드 |
| ------------------------- | ----------------- | --------- | --------- | --------- | ------ |
| `--semantic-icon-default` | `cv.icon.default` | `#383838` | `#333333` | `#333333` |        |
| `--semantic-icon-subtle`  | `cv.icon.subtle`  | `#999999` | `#979797` | `#999999` |        |
| `--semantic-icon-inverse` | `cv.icon.inverse` | `#FFFFFF` | `#FFFFFF` | `#FFFFFF` |        |
