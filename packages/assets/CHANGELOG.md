...
- 912e3ce: 지니어트(Geniet) 브랜드 자산 편입 — 음식종류·카테고리·프로필·워드마크 146종
...
- 2b51ea7: NudgeEAP 로고 변종(koen/ko/en/en-dark/symbol)과 DAIN 마크의 SVG base64 dataURI 를 assets SSOT(`brand-logo-defaults` + `brand-logo-manifest`)에 추가했습니다.
