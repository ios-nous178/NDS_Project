...
export const MARATHON_EVENT_METADATA: Record<MarathonEventId, MarathonEventMeta> = {
  error: {
    ...
    filename3x: "marathon-events/error@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:310",
    figmaNodeName: "오류",
  },
  "dangdangi-race": {
    ...
    filename3x: "marathon-events/dangdangi-race@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:312",
  ...
  "gaenari-run": {
    ...
    filename3x: "marathon-events/gaenari-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:311",
    figmaNodeName: "개나리런",
  },
  "pokemon-run": {
    ...
    filename3x: "marathon-events/pokemon-run@3x.png",
    mimeType: "image/png",
  ...
  "yeontan-run": {
    ...
    filename3x: "marathon-events/yeontan-run@3x.png",
    mimeType: "image/png",
  ...
  "shinhan-donghaeng-run": {
    ...
    filename3x: "marathon-events/shinhan-donghaeng-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:309",
    figmaNodeName: "신한동행런",
  },
  "santa-claus-run": {
    ...
    filename3x: "marathon-events/santa-claus-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:308",
  ...
  "seokchon-night-run": {
    ...
    filename3x: "marathon-events/seokchon-night-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:307",
  ...
  "hangang-night-run": {
    ...
    filename3x: "marathon-events/hangang-night-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:306",
  ...
  "bomkkot-run": {
    ...
    filename3x: "marathon-events/bomkkot-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:305",
    figmaNodeName: "봄꽃런",
  },
  "animal-run": {
    ...
    filename3x: "marathon-events/animal-run@3x.png",
    mimeType: "image/png",
    figmaNodeId: "27:304",
    figmaNodeName: "애니멀런",
  },
