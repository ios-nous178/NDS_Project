...
const StarIcon = () => {
  ...
  svg.innerHTML = `<path d="M7 1L8.85 4.75L13 5.35L10 8.27L10.71 12.4L7 10.45L3.29 12.4L4 8.27L1 5.35L5.15 4.75L7 1Z" fill="#FFB800" stroke="#FFB800" stroke-width="0.5" stroke-linejoin="round" />`;
  return svg;
};
