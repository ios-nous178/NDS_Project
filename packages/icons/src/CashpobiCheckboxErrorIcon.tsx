...
export interface CashpobiCheckboxErrorIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiCheckboxErrorIcon = React.forwardRef<SVGSVGElement, CashpobiCheckboxErrorIconProps>(
...
CashpobiCheckboxErrorIcon.displayName = "CashpobiCheckboxErrorIcon";
