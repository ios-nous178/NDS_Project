...
export interface CashpobiMessageQuizIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiMessageQuizIcon = React.forwardRef<SVGSVGElement, CashpobiMessageQuizIconProps>(
...
CashpobiMessageQuizIcon.displayName = "CashpobiMessageQuizIcon";
