...
export interface GenietReviewOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietReviewOffIcon = React.forwardRef<SVGSVGElement, GenietReviewOffIconProps>(
...
GenietReviewOffIcon.displayName = "GenietReviewOffIcon";
