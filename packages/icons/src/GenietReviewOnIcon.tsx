...
export interface GenietReviewOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietReviewOnIcon = React.forwardRef<SVGSVGElement, GenietReviewOnIconProps>(
  ({ size = 24, color = "currentColor", ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <g id="icon/bottomnavi/review/on" clipPath="url(#clip0_0_35)">
<g id="Rectangle">
</g>
...
GenietReviewOnIcon.displayName = "GenietReviewOnIcon";
