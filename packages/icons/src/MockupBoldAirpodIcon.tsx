...
export interface MockupBoldAirpodIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAirpodIcon = React.forwardRef<SVGSVGElement, MockupBoldAirpodIconProps>(
...
MockupBoldAirpodIcon.displayName = "MockupBoldAirpodIcon";
