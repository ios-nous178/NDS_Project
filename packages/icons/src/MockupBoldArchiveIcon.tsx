...
export interface MockupBoldArchiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArchiveIcon = React.forwardRef<SVGSVGElement, MockupBoldArchiveIconProps>(
