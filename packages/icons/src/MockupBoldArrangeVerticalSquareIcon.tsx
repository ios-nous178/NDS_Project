...
export interface MockupBoldArrangeVerticalSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrangeVerticalSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldArrangeVerticalSquareIconProps>(
...
MockupBoldArrangeVerticalSquareIcon.displayName = "MockupBoldArrangeVerticalSquareIcon";
