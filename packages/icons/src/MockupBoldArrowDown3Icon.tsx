...
export interface MockupBoldArrowDown3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowDown3Icon = React.forwardRef<SVGSVGElement, MockupBoldArrowDown3IconProps>(
...
MockupBoldArrowDown3Icon.displayName = "MockupBoldArrowDown3Icon";
