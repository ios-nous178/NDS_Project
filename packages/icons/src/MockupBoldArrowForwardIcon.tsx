...
export interface MockupBoldArrowForwardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowForwardIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowForwardIconProps>(
...
MockupBoldArrowForwardIcon.displayName = "MockupBoldArrowForwardIcon";
