...
export interface MockupBoldArrowForwardSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowForwardSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowForwardSquareIconProps>(
...
MockupBoldArrowForwardSquareIcon.displayName = "MockupBoldArrowForwardSquareIcon";
