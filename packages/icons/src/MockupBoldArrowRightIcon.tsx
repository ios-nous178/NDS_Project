...
export interface MockupBoldArrowRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowRightIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowRightIconProps>(
...
MockupBoldArrowRightIcon.displayName = "MockupBoldArrowRightIcon";
