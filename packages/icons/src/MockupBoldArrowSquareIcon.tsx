...
export interface MockupBoldArrowSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowSquareIconProps>(
...
MockupBoldArrowSquareIcon.displayName = "MockupBoldArrowSquareIcon";
