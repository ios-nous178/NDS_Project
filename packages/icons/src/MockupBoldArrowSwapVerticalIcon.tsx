...
export interface MockupBoldArrowSwapVerticalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowSwapVerticalIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowSwapVerticalIconProps>(
...
MockupBoldArrowSwapVerticalIcon.displayName = "MockupBoldArrowSwapVerticalIcon";
