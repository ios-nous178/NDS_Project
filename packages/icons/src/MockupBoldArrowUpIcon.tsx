...
export interface MockupBoldArrowUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowUpIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowUpIconProps>(
...
MockupBoldArrowUpIcon.displayName = "MockupBoldArrowUpIcon";
