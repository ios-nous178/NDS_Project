...
export interface MockupBoldAutobrightnessIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAutobrightnessIcon = React.forwardRef<SVGSVGElement, MockupBoldAutobrightnessIconProps>(
