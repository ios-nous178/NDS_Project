...
export interface MockupBoldBackIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBackIcon = React.forwardRef<SVGSVGElement, MockupBoldBackIconProps>(
...
MockupBoldBackIcon.displayName = "MockupBoldBackIcon";
