...
export interface MockupBoldBackward5SecondsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBackward5SecondsIcon = React.forwardRef<SVGSVGElement, MockupBoldBackward5SecondsIconProps>(
