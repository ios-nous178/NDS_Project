...
export interface MockupBoldBag2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBag2Icon = React.forwardRef<SVGSVGElement, MockupBoldBag2IconProps>(
...
MockupBoldBag2Icon.displayName = "MockupBoldBag2Icon";
