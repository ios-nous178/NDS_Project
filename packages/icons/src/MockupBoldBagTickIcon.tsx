...
export interface MockupBoldBagTickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBagTickIcon = React.forwardRef<SVGSVGElement, MockupBoldBagTickIconProps>(
