...
export interface MockupBoldBatteryChargingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBatteryChargingIcon = React.forwardRef<SVGSVGElement, MockupBoldBatteryChargingIconProps>(
