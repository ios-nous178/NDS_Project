...
export interface MockupBoldBitcoinConvertIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBitcoinConvertIcon = React.forwardRef<SVGSVGElement, MockupBoldBitcoinConvertIconProps>(
