...
export interface MockupBoldBlend2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBlend2Icon = React.forwardRef<SVGSVGElement, MockupBoldBlend2IconProps>(
