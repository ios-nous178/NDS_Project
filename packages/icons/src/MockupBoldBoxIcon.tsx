...
export interface MockupBoldBoxIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBoxIcon = React.forwardRef<SVGSVGElement, MockupBoldBoxIconProps>(
