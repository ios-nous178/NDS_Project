...
export interface MockupBoldBusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBusIcon = React.forwardRef<SVGSVGElement, MockupBoldBusIconProps>(
