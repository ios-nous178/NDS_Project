...
export interface MockupBoldCalculatorIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCalculatorIcon = React.forwardRef<SVGSVGElement, MockupBoldCalculatorIconProps>(
...
MockupBoldCalculatorIcon.displayName = "MockupBoldCalculatorIcon";
