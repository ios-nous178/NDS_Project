...
export interface MockupBoldCalendarAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCalendarAddIcon = React.forwardRef<SVGSVGElement, MockupBoldCalendarAddIconProps>(
