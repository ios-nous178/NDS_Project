...
export interface MockupBoldCallAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCallAddIcon = React.forwardRef<SVGSVGElement, MockupBoldCallAddIconProps>(
...
MockupBoldCallAddIcon.displayName = "MockupBoldCallAddIcon";
