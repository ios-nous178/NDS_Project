...
export interface MockupBoldCallCallingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCallCallingIcon = React.forwardRef<SVGSVGElement, MockupBoldCallCallingIconProps>(
