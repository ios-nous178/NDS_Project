...
export interface MockupBoldCallMinusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCallMinusIcon = React.forwardRef<SVGSVGElement, MockupBoldCallMinusIconProps>(
...
MockupBoldCallMinusIcon.displayName = "MockupBoldCallMinusIcon";
