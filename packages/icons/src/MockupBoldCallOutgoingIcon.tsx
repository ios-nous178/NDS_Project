...
export interface MockupBoldCallOutgoingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCallOutgoingIcon = React.forwardRef<SVGSVGElement, MockupBoldCallOutgoingIconProps>(
...
MockupBoldCallOutgoingIcon.displayName = "MockupBoldCallOutgoingIcon";
