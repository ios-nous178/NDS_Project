...
export interface MockupBoldCallSlashIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCallSlashIcon = React.forwardRef<SVGSVGElement, MockupBoldCallSlashIconProps>(
