...
export interface MockupBoldCameraIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCameraIcon = React.forwardRef<SVGSVGElement, MockupBoldCameraIconProps>(
...
MockupBoldCameraIcon.displayName = "MockupBoldCameraIcon";
