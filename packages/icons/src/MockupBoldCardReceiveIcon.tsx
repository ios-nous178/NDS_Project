...
export interface MockupBoldCardReceiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCardReceiveIcon = React.forwardRef<SVGSVGElement, MockupBoldCardReceiveIconProps>(
