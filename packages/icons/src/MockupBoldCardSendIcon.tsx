...
export interface MockupBoldCardSendIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCardSendIcon = React.forwardRef<SVGSVGElement, MockupBoldCardSendIconProps>(
...
MockupBoldCardSendIcon.displayName = "MockupBoldCardSendIcon";
