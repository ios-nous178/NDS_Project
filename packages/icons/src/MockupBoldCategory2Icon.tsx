...
export interface MockupBoldCategory2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCategory2Icon = React.forwardRef<SVGSVGElement, MockupBoldCategory2IconProps>(
