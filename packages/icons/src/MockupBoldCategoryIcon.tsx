...
export interface MockupBoldCategoryIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCategoryIcon = React.forwardRef<SVGSVGElement, MockupBoldCategoryIconProps>(
