...
export interface MockupBoldChartFailIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldChartFailIcon = React.forwardRef<SVGSVGElement, MockupBoldChartFailIconProps>(
