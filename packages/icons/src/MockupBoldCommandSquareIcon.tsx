...
export interface MockupBoldCommandSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCommandSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldCommandSquareIconProps>(
