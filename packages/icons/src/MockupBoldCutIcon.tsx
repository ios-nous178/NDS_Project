...
export interface MockupBoldCutIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCutIcon = React.forwardRef<SVGSVGElement, MockupBoldCutIconProps>(
