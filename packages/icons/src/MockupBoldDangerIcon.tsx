...
export interface MockupBoldDangerIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDangerIcon = React.forwardRef<SVGSVGElement, MockupBoldDangerIconProps>(
