...
export interface MockupBoldDiagramIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDiagramIcon = React.forwardRef<SVGSVGElement, MockupBoldDiagramIconProps>(
