...
export interface MockupBoldDirectIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDirectIcon = React.forwardRef<SVGSVGElement, MockupBoldDirectIconProps>(
