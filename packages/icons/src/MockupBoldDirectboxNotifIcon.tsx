...
export interface MockupBoldDirectboxNotifIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDirectboxNotifIcon = React.forwardRef<SVGSVGElement, MockupBoldDirectboxNotifIconProps>(
