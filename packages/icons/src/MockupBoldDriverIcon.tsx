...
export interface MockupBoldDriverIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDriverIcon = React.forwardRef<SVGSVGElement, MockupBoldDriverIconProps>(
...
MockupBoldDriverIcon.displayName = "MockupBoldDriverIcon";
