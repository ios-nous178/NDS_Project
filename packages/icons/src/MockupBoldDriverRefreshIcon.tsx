...
export interface MockupBoldDriverRefreshIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDriverRefreshIcon = React.forwardRef<SVGSVGElement, MockupBoldDriverRefreshIconProps>(
