...
export interface MockupBoldEdit2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldEdit2Icon = React.forwardRef<SVGSVGElement, MockupBoldEdit2IconProps>(
