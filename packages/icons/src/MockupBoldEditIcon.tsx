...
export interface MockupBoldEditIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldEditIcon = React.forwardRef<SVGSVGElement, MockupBoldEditIconProps>(
