...
export interface MockupBoldEmojiHappyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldEmojiHappyIcon = React.forwardRef<SVGSVGElement, MockupBoldEmojiHappyIconProps>(
...
MockupBoldEmojiHappyIcon.displayName = "MockupBoldEmojiHappyIcon";
