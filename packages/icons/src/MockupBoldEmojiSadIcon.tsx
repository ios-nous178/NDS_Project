...
export interface MockupBoldEmojiSadIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldEmojiSadIcon = React.forwardRef<SVGSVGElement, MockupBoldEmojiSadIconProps>(
