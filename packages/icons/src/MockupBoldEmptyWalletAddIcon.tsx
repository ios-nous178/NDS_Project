...
export interface MockupBoldEmptyWalletAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldEmptyWalletAddIcon = React.forwardRef<SVGSVGElement, MockupBoldEmptyWalletAddIconProps>(
