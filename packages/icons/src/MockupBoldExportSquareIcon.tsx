...
export interface MockupBoldExportSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldExportSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldExportSquareIconProps>(
...
MockupBoldExportSquareIcon.displayName = "MockupBoldExportSquareIcon";
