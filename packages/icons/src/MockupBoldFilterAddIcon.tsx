...
export interface MockupBoldFilterAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFilterAddIcon = React.forwardRef<SVGSVGElement, MockupBoldFilterAddIconProps>(
