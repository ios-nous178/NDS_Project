...
export interface MockupBoldFilterSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFilterSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldFilterSquareIconProps>(
...
MockupBoldFilterSquareIcon.displayName = "MockupBoldFilterSquareIcon";
