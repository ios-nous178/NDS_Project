...
export interface MockupBoldFolderIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFolderIcon = React.forwardRef<SVGSVGElement, MockupBoldFolderIconProps>(
...
MockupBoldFolderIcon.displayName = "MockupBoldFolderIcon";
