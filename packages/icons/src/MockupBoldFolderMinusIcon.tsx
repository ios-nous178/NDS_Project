...
export interface MockupBoldFolderMinusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFolderMinusIcon = React.forwardRef<SVGSVGElement, MockupBoldFolderMinusIconProps>(
