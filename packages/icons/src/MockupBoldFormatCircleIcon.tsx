...
export interface MockupBoldFormatCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFormatCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldFormatCircleIconProps>(
