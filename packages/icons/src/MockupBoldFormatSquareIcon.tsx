...
export interface MockupBoldFormatSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFormatSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldFormatSquareIconProps>(
