...
export interface MockupBoldGameIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGameIcon = React.forwardRef<SVGSVGElement, MockupBoldGameIconProps>(
