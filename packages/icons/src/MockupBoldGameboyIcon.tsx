...
export interface MockupBoldGameboyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGameboyIcon = React.forwardRef<SVGSVGElement, MockupBoldGameboyIconProps>(
