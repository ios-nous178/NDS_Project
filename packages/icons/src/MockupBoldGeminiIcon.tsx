...
export interface MockupBoldGeminiIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGeminiIcon = React.forwardRef<SVGSVGElement, MockupBoldGeminiIconProps>(
