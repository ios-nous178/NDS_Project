...
export interface MockupBoldGiftIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGiftIcon = React.forwardRef<SVGSVGElement, MockupBoldGiftIconProps>(
