...
export interface MockupBoldGpsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGpsIcon = React.forwardRef<SVGSVGElement, MockupBoldGpsIconProps>(
...
MockupBoldGpsIcon.displayName = "MockupBoldGpsIcon";
