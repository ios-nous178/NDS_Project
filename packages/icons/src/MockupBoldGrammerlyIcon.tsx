...
export interface MockupBoldGrammerlyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGrammerlyIcon = React.forwardRef<SVGSVGElement, MockupBoldGrammerlyIconProps>(
...
MockupBoldGrammerlyIcon.displayName = "MockupBoldGrammerlyIcon";
