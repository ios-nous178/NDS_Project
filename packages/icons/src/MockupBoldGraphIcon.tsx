...
export interface MockupBoldGraphIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGraphIcon = React.forwardRef<SVGSVGElement, MockupBoldGraphIconProps>(
