...
export interface MockupBoldGridLockIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGridLockIcon = React.forwardRef<SVGSVGElement, MockupBoldGridLockIconProps>(
...
MockupBoldGridLockIcon.displayName = "MockupBoldGridLockIcon";
