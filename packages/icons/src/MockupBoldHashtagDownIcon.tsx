...
export interface MockupBoldHashtagDownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHashtagDownIcon = React.forwardRef<SVGSVGElement, MockupBoldHashtagDownIconProps>(
