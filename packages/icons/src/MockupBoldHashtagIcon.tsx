...
export interface MockupBoldHashtagIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHashtagIcon = React.forwardRef<SVGSVGElement, MockupBoldHashtagIconProps>(
