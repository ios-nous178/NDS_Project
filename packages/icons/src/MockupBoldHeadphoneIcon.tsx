...
export interface MockupBoldHeadphoneIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHeadphoneIcon = React.forwardRef<SVGSVGElement, MockupBoldHeadphoneIconProps>(
...
MockupBoldHeadphoneIcon.displayName = "MockupBoldHeadphoneIcon";
