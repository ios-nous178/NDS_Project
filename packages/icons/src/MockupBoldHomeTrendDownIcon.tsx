...
export interface MockupBoldHomeTrendDownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHomeTrendDownIcon = React.forwardRef<SVGSVGElement, MockupBoldHomeTrendDownIconProps>(
