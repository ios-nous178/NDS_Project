...
export interface MockupBoldHouseIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHouseIcon = React.forwardRef<SVGSVGElement, MockupBoldHouseIconProps>(
