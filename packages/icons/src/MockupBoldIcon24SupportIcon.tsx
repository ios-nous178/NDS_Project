...
export interface MockupBoldIcon24SupportIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldIcon24SupportIcon = React.forwardRef<SVGSVGElement, MockupBoldIcon24SupportIconProps>(
