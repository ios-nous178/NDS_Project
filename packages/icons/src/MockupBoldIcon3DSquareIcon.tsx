...
export interface MockupBoldIcon3DSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldIcon3DSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldIcon3DSquareIconProps>(
