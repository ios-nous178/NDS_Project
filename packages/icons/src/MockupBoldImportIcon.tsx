...
export interface MockupBoldImportIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldImportIcon = React.forwardRef<SVGSVGElement, MockupBoldImportIconProps>(
...
MockupBoldImportIcon.displayName = "MockupBoldImportIcon";
