...
export interface MockupBoldInformationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldInformationIcon = React.forwardRef<SVGSVGElement, MockupBoldInformationIconProps>(
...
MockupBoldInformationIcon.displayName = "MockupBoldInformationIcon";
