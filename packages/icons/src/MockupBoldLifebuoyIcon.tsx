...
export interface MockupBoldLifebuoyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLifebuoyIcon = React.forwardRef<SVGSVGElement, MockupBoldLifebuoyIconProps>(
