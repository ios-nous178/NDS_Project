...
export interface MockupBoldLike1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLike1Icon = React.forwardRef<SVGSVGElement, MockupBoldLike1IconProps>(
