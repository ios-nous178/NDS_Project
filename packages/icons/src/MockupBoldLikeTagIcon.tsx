...
export interface MockupBoldLikeTagIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLikeTagIcon = React.forwardRef<SVGSVGElement, MockupBoldLikeTagIconProps>(
