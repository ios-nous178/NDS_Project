...
export interface MockupBoldLock1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLock1Icon = React.forwardRef<SVGSVGElement, MockupBoldLock1IconProps>(
