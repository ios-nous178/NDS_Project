...
export interface MockupBoldMathIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMathIcon = React.forwardRef<SVGSVGElement, MockupBoldMathIconProps>(
...
MockupBoldMathIcon.displayName = "MockupBoldMathIcon";
