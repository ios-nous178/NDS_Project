...
export interface MockupBoldMaximizeCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaximizeCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldMaximizeCircleIconProps>(
