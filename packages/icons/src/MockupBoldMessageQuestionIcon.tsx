...
export interface MockupBoldMessageQuestionIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMessageQuestionIcon = React.forwardRef<SVGSVGElement, MockupBoldMessageQuestionIconProps>(
...
MockupBoldMessageQuestionIcon.displayName = "MockupBoldMessageQuestionIcon";
