...
export interface MockupBoldMilkIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMilkIcon = React.forwardRef<SVGSVGElement, MockupBoldMilkIconProps>(
