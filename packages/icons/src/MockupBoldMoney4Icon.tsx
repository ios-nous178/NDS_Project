...
export interface MockupBoldMoney4IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMoney4Icon = React.forwardRef<SVGSVGElement, MockupBoldMoney4IconProps>(
