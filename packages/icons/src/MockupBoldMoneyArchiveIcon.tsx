...
export interface MockupBoldMoneyArchiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMoneyArchiveIcon = React.forwardRef<SVGSVGElement, MockupBoldMoneyArchiveIconProps>(
