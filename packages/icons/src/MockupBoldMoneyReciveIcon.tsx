...
export interface MockupBoldMoneyReciveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMoneyReciveIcon = React.forwardRef<SVGSVGElement, MockupBoldMoneyReciveIconProps>(
