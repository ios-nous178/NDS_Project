...
export interface MockupBoldMusicFilterIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMusicFilterIcon = React.forwardRef<SVGSVGElement, MockupBoldMusicFilterIconProps>(
