...
export interface MockupBoldMusicSquareRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMusicSquareRemoveIcon = React.forwardRef<SVGSVGElement, MockupBoldMusicSquareRemoveIconProps>(
