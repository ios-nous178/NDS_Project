...
export interface MockupBoldNoteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldNoteIcon = React.forwardRef<SVGSVGElement, MockupBoldNoteIconProps>(
