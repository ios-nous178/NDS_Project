...
export interface MockupBoldOmegaCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldOmegaCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldOmegaCircleIconProps>(
...
MockupBoldOmegaCircleIcon.displayName = "MockupBoldOmegaCircleIcon";
