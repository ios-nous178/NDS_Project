...
export interface MockupBoldPaintbucketIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPaintbucketIcon = React.forwardRef<SVGSVGElement, MockupBoldPaintbucketIconProps>(
