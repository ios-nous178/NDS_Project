...
export interface MockupBoldPathToolSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPathToolSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldPathToolSquareIconProps>(
