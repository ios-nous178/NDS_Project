...
export interface MockupBoldPeopleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPeopleIcon = React.forwardRef<SVGSVGElement, MockupBoldPeopleIconProps>(
