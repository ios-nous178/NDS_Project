...
export interface MockupBoldPlayCricleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPlayCricleIcon = React.forwardRef<SVGSVGElement, MockupBoldPlayCricleIconProps>(
