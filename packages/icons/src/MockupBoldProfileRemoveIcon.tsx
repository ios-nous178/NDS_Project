...
export interface MockupBoldProfileRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldProfileRemoveIcon = React.forwardRef<SVGSVGElement, MockupBoldProfileRemoveIconProps>(
