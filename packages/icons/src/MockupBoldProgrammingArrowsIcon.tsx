...
export interface MockupBoldProgrammingArrowsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldProgrammingArrowsIcon = React.forwardRef<SVGSVGElement, MockupBoldProgrammingArrowsIconProps>(
