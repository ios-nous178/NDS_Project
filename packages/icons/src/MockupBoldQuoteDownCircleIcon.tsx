...
export interface MockupBoldQuoteDownCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldQuoteDownCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldQuoteDownCircleIconProps>(
...
MockupBoldQuoteDownCircleIcon.displayName = "MockupBoldQuoteDownCircleIcon";
