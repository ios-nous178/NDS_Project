...
export interface MockupBoldQuoteDownSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldQuoteDownSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldQuoteDownSquareIconProps>(
