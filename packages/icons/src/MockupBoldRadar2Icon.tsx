...
export interface MockupBoldRadar2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRadar2Icon = React.forwardRef<SVGSVGElement, MockupBoldRadar2IconProps>(
...
MockupBoldRadar2Icon.displayName = "MockupBoldRadar2Icon";
