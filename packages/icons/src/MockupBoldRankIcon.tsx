...
export interface MockupBoldRankIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRankIcon = React.forwardRef<SVGSVGElement, MockupBoldRankIconProps>(
