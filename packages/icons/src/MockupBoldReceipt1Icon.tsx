...
export interface MockupBoldReceipt1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceipt1Icon = React.forwardRef<SVGSVGElement, MockupBoldReceipt1IconProps>(
...
MockupBoldReceipt1Icon.displayName = "MockupBoldReceipt1Icon";
