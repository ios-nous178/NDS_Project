...
export interface MockupBoldReceipt21IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceipt21Icon = React.forwardRef<SVGSVGElement, MockupBoldReceipt21IconProps>(
...
MockupBoldReceipt21Icon.displayName = "MockupBoldReceipt21Icon";
