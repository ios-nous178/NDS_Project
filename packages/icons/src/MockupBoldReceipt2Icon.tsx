...
export interface MockupBoldReceipt2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceipt2Icon = React.forwardRef<SVGSVGElement, MockupBoldReceipt2IconProps>(
...
MockupBoldReceipt2Icon.displayName = "MockupBoldReceipt2Icon";
