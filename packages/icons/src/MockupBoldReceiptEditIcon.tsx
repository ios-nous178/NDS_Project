...
export interface MockupBoldReceiptEditIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceiptEditIcon = React.forwardRef<SVGSVGElement, MockupBoldReceiptEditIconProps>(
...
MockupBoldReceiptEditIcon.displayName = "MockupBoldReceiptEditIcon";
