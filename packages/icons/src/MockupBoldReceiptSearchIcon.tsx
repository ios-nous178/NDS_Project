...
export interface MockupBoldReceiptSearchIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceiptSearchIcon = React.forwardRef<SVGSVGElement, MockupBoldReceiptSearchIconProps>(
...
MockupBoldReceiptSearchIcon.displayName = "MockupBoldReceiptSearchIcon";
