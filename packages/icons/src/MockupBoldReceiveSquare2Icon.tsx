...
export interface MockupBoldReceiveSquare2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceiveSquare2Icon = React.forwardRef<SVGSVGElement, MockupBoldReceiveSquare2IconProps>(
...
MockupBoldReceiveSquare2Icon.displayName = "MockupBoldReceiveSquare2Icon";
