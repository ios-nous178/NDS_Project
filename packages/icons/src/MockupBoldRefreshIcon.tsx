...
export interface MockupBoldRefreshIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRefreshIcon = React.forwardRef<SVGSVGElement, MockupBoldRefreshIconProps>(
...
MockupBoldRefreshIcon.displayName = "MockupBoldRefreshIcon";
