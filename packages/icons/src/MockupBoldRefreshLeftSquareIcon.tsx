...
export interface MockupBoldRefreshLeftSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRefreshLeftSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldRefreshLeftSquareIconProps>(
...
MockupBoldRefreshLeftSquareIcon.displayName = "MockupBoldRefreshLeftSquareIcon";
