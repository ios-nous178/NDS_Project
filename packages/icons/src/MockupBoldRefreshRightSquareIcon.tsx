...
export interface MockupBoldRefreshRightSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRefreshRightSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldRefreshRightSquareIconProps>(
...
MockupBoldRefreshRightSquareIcon.displayName = "MockupBoldRefreshRightSquareIcon";
