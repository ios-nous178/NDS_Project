...
export interface MockupBoldRefreshSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRefreshSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldRefreshSquareIconProps>(
...
MockupBoldRefreshSquareIcon.displayName = "MockupBoldRefreshSquareIcon";
