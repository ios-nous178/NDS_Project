...
export interface MockupBoldRepeatCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRepeatCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldRepeatCircleIconProps>(
...
MockupBoldRepeatCircleIcon.displayName = "MockupBoldRepeatCircleIcon";
