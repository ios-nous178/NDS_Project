...
export interface MockupBoldRepeatIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRepeatIcon = React.forwardRef<SVGSVGElement, MockupBoldRepeatIconProps>(
