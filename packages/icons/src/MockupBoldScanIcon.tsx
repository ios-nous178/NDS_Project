...
export interface MockupBoldScanIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldScanIcon = React.forwardRef<SVGSVGElement, MockupBoldScanIconProps>(
