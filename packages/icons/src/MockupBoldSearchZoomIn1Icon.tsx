...
export interface MockupBoldSearchZoomIn1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSearchZoomIn1Icon = React.forwardRef<SVGSVGElement, MockupBoldSearchZoomIn1IconProps>(
...
MockupBoldSearchZoomIn1Icon.displayName = "MockupBoldSearchZoomIn1Icon";
