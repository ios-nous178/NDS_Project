...
export interface MockupBoldShuffleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldShuffleIcon = React.forwardRef<SVGSVGElement, MockupBoldShuffleIconProps>(
