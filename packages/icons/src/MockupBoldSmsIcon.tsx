...
export interface MockupBoldSmsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSmsIcon = React.forwardRef<SVGSVGElement, MockupBoldSmsIconProps>(
...
MockupBoldSmsIcon.displayName = "MockupBoldSmsIcon";
