...
export interface MockupBoldSortIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSortIcon = React.forwardRef<SVGSVGElement, MockupBoldSortIconProps>(
...
MockupBoldSortIcon.displayName = "MockupBoldSortIcon";
