...
export interface MockupBoldSubtitleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSubtitleIcon = React.forwardRef<SVGSVGElement, MockupBoldSubtitleIconProps>(
...
MockupBoldSubtitleIcon.displayName = "MockupBoldSubtitleIcon";
