...
export interface MockupBoldSun1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSun1Icon = React.forwardRef<SVGSVGElement, MockupBoldSun1IconProps>(
