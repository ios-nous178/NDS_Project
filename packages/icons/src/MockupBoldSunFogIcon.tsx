...
export interface MockupBoldSunFogIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSunFogIcon = React.forwardRef<SVGSVGElement, MockupBoldSunFogIconProps>(
...
MockupBoldSunFogIcon.displayName = "MockupBoldSunFogIcon";
