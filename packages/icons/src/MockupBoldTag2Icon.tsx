...
export interface MockupBoldTag2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTag2Icon = React.forwardRef<SVGSVGElement, MockupBoldTag2IconProps>(
