...
export interface MockupBoldTaskIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTaskIcon = React.forwardRef<SVGSVGElement, MockupBoldTaskIconProps>(
