...
export interface MockupBoldTaskSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTaskSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldTaskSquareIconProps>(
