...
export interface MockupBoldTextIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTextIcon = React.forwardRef<SVGSVGElement, MockupBoldTextIconProps>(
