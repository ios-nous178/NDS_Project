...
export interface MockupBoldTimerIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTimerIcon = React.forwardRef<SVGSVGElement, MockupBoldTimerIconProps>(
