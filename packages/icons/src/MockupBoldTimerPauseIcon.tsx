...
export interface MockupBoldTimerPauseIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTimerPauseIcon = React.forwardRef<SVGSVGElement, MockupBoldTimerPauseIconProps>(
