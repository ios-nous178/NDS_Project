...
export interface MockupBoldTrendUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTrendUpIcon = React.forwardRef<SVGSVGElement, MockupBoldTrendUpIconProps>(
...
MockupBoldTrendUpIcon.displayName = "MockupBoldTrendUpIcon";
