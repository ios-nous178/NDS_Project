...
export interface MockupBoldTruckRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTruckRemoveIcon = React.forwardRef<SVGSVGElement, MockupBoldTruckRemoveIconProps>(
...
MockupBoldTruckRemoveIcon.displayName = "MockupBoldTruckRemoveIcon";
