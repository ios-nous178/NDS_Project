...
export interface MockupBoldUserAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldUserAddIcon = React.forwardRef<SVGSVGElement, MockupBoldUserAddIconProps>(
