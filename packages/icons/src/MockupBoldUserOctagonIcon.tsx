...
export interface MockupBoldUserOctagonIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldUserOctagonIcon = React.forwardRef<SVGSVGElement, MockupBoldUserOctagonIconProps>(
