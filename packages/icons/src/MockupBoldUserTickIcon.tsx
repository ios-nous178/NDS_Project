...
export interface MockupBoldUserTickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldUserTickIcon = React.forwardRef<SVGSVGElement, MockupBoldUserTickIconProps>(
