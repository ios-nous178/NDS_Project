...
export interface MockupBoldVideoPlayIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVideoPlayIcon = React.forwardRef<SVGSVGElement, MockupBoldVideoPlayIconProps>(
...
MockupBoldVideoPlayIcon.displayName = "MockupBoldVideoPlayIcon";
