...
export interface MockupBoldVideoTimeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVideoTimeIcon = React.forwardRef<SVGSVGElement, MockupBoldVideoTimeIconProps>(
...
MockupBoldVideoTimeIcon.displayName = "MockupBoldVideoTimeIcon";
