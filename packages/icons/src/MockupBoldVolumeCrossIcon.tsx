...
export interface MockupBoldVolumeCrossIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVolumeCrossIcon = React.forwardRef<SVGSVGElement, MockupBoldVolumeCrossIconProps>(
...
MockupBoldVolumeCrossIcon.displayName = "MockupBoldVolumeCrossIcon";
