...
export interface MockupBoldWallet1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWallet1Icon = React.forwardRef<SVGSVGElement, MockupBoldWallet1IconProps>(
