...
export interface MockupBoldWarning2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWarning2Icon = React.forwardRef<SVGSVGElement, MockupBoldWarning2IconProps>(
...
MockupBoldWarning2Icon.displayName = "MockupBoldWarning2Icon";
