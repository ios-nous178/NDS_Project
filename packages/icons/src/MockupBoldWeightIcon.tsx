...
export interface MockupBoldWeightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWeightIcon = React.forwardRef<SVGSVGElement, MockupBoldWeightIconProps>(
...
MockupBoldWeightIcon.displayName = "MockupBoldWeightIcon";
