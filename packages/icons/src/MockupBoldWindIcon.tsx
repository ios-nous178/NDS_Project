...
export interface MockupBoldWindIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWindIcon = React.forwardRef<SVGSVGElement, MockupBoldWindIconProps>(
