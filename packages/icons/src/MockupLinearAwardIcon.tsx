...
export interface MockupLinearAwardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearAwardIcon = React.forwardRef<SVGSVGElement, MockupLinearAwardIconProps>(
...
MockupLinearAwardIcon.displayName = "MockupLinearAwardIcon";
