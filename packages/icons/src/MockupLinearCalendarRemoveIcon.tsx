...
export interface MockupLinearCalendarRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCalendarRemoveIcon = React.forwardRef<SVGSVGElement, MockupLinearCalendarRemoveIconProps>(
