...
export interface MockupLinearCardCoinIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCardCoinIcon = React.forwardRef<SVGSVGElement, MockupLinearCardCoinIconProps>(
