...
export interface MockupLinearCategoryIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCategoryIcon = React.forwardRef<SVGSVGElement, MockupLinearCategoryIconProps>(
...
MockupLinearCategoryIcon.displayName = "MockupLinearCategoryIcon";
