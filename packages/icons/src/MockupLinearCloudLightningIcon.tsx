...
export interface MockupLinearCloudLightningIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCloudLightningIcon = React.forwardRef<SVGSVGElement, MockupLinearCloudLightningIconProps>(
...
MockupLinearCloudLightningIcon.displayName = "MockupLinearCloudLightningIcon";
