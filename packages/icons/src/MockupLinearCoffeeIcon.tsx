...
export interface MockupLinearCoffeeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCoffeeIcon = React.forwardRef<SVGSVGElement, MockupLinearCoffeeIconProps>(
...
MockupLinearCoffeeIcon.displayName = "MockupLinearCoffeeIcon";
