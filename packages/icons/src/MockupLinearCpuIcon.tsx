...
export interface MockupLinearCpuIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCpuIcon = React.forwardRef<SVGSVGElement, MockupLinearCpuIconProps>(
...
MockupLinearCpuIcon.displayName = "MockupLinearCpuIcon";
