...
export interface MockupLinearDislikeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearDislikeIcon = React.forwardRef<SVGSVGElement, MockupLinearDislikeIconProps>(
...
MockupLinearDislikeIcon.displayName = "MockupLinearDislikeIcon";
