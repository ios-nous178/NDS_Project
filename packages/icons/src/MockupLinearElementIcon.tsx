...
export interface MockupLinearElementIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearElementIcon = React.forwardRef<SVGSVGElement, MockupLinearElementIconProps>(
...
MockupLinearElementIcon.displayName = "MockupLinearElementIcon";
