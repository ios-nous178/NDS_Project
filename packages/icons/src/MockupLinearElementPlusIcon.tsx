...
export interface MockupLinearElementPlusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearElementPlusIcon = React.forwardRef<SVGSVGElement, MockupLinearElementPlusIconProps>(
