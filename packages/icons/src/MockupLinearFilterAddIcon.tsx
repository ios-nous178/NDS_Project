...
export interface MockupLinearFilterAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearFilterAddIcon = React.forwardRef<SVGSVGElement, MockupLinearFilterAddIconProps>(
