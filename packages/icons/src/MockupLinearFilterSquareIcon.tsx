...
export interface MockupLinearFilterSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearFilterSquareIcon = React.forwardRef<SVGSVGElement, MockupLinearFilterSquareIconProps>(
...
MockupLinearFilterSquareIcon.displayName = "MockupLinearFilterSquareIcon";
