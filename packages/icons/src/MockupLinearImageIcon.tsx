...
export interface MockupLinearImageIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearImageIcon = React.forwardRef<SVGSVGElement, MockupLinearImageIconProps>(
...
MockupLinearImageIcon.displayName = "MockupLinearImageIcon";
