...
export interface MockupLinearLike1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearLike1Icon = React.forwardRef<SVGSVGElement, MockupLinearLike1IconProps>(
...
MockupLinearLike1Icon.displayName = "MockupLinearLike1Icon";
