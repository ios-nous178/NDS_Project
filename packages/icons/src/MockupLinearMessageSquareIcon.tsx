...
export interface MockupLinearMessageSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearMessageSquareIcon = React.forwardRef<SVGSVGElement, MockupLinearMessageSquareIconProps>(
...
MockupLinearMessageSquareIcon.displayName = "MockupLinearMessageSquareIcon";
