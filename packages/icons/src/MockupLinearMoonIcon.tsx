...
export interface MockupLinearMoonIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearMoonIcon = React.forwardRef<SVGSVGElement, MockupLinearMoonIconProps>(
...
MockupLinearMoonIcon.displayName = "MockupLinearMoonIcon";
