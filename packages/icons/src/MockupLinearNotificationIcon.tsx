...
export interface MockupLinearNotificationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearNotificationIcon = React.forwardRef<SVGSVGElement, MockupLinearNotificationIconProps>(
