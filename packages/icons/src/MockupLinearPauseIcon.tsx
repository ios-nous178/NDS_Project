...
export interface MockupLinearPauseIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearPauseIcon = React.forwardRef<SVGSVGElement, MockupLinearPauseIconProps>(
...
MockupLinearPauseIcon.displayName = "MockupLinearPauseIcon";
