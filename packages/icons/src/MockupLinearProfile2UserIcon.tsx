...
export interface MockupLinearProfile2UserIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearProfile2UserIcon = React.forwardRef<SVGSVGElement, MockupLinearProfile2UserIconProps>(
...
MockupLinearProfile2UserIcon.displayName = "MockupLinearProfile2UserIcon";
