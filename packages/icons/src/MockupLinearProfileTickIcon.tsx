...
export interface MockupLinearProfileTickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearProfileTickIcon = React.forwardRef<SVGSVGElement, MockupLinearProfileTickIconProps>(
...
MockupLinearProfileTickIcon.displayName = "MockupLinearProfileTickIcon";
