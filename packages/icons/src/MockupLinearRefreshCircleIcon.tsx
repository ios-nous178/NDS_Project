...
export interface MockupLinearRefreshCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearRefreshCircleIcon = React.forwardRef<SVGSVGElement, MockupLinearRefreshCircleIconProps>(
...
MockupLinearRefreshCircleIcon.displayName = "MockupLinearRefreshCircleIcon";
