...
export interface MockupLinearSaveAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearSaveAddIcon = React.forwardRef<SVGSVGElement, MockupLinearSaveAddIconProps>(
