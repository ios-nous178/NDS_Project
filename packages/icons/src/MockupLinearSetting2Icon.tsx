...
export interface MockupLinearSetting2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearSetting2Icon = React.forwardRef<SVGSVGElement, MockupLinearSetting2IconProps>(
...
MockupLinearSetting2Icon.displayName = "MockupLinearSetting2Icon";
