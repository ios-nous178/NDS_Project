...
export interface MockupLinearShareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearShareIcon = React.forwardRef<SVGSVGElement, MockupLinearShareIconProps>(
...
MockupLinearShareIcon.displayName = "MockupLinearShareIcon";
