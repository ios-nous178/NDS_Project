...
export interface MockupLinearShoppingCartIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearShoppingCartIcon = React.forwardRef<SVGSVGElement, MockupLinearShoppingCartIconProps>(
...
MockupLinearShoppingCartIcon.displayName = "MockupLinearShoppingCartIcon";
