...
export interface MockupLinearStarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearStarIcon = React.forwardRef<SVGSVGElement, MockupLinearStarIconProps>(
...
MockupLinearStarIcon.displayName = "MockupLinearStarIcon";
