...
export interface MockupLinearVerifyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearVerifyIcon = React.forwardRef<SVGSVGElement, MockupLinearVerifyIconProps>(
