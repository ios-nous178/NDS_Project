...
export interface CashpobiCheckCircleOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiCheckCircleOffIcon = React.forwardRef<SVGSVGElement, CashpobiCheckCircleOffIconProps>(
...
CashpobiCheckCircleOffIcon.displayName = "CashpobiCheckCircleOffIcon";
