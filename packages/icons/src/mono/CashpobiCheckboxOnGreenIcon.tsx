...
export interface CashpobiCheckboxOnGreenIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiCheckboxOnGreenIcon = React.forwardRef<SVGSVGElement, CashpobiCheckboxOnGreenIconProps>(
...
CashpobiCheckboxOnGreenIcon.displayName = "CashpobiCheckboxOnGreenIcon";
