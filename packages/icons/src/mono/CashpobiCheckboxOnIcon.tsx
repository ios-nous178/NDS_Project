...
export interface CashpobiCheckboxOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiCheckboxOnIcon = React.forwardRef<SVGSVGElement, CashpobiCheckboxOnIconProps>(
...
CashpobiCheckboxOnIcon.displayName = "CashpobiCheckboxOnIcon";
