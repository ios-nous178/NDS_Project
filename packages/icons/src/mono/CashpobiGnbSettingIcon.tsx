...
export interface CashpobiGnbSettingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiGnbSettingIcon = React.forwardRef<SVGSVGElement, CashpobiGnbSettingIconProps>(
...
CashpobiGnbSettingIcon.displayName = "CashpobiGnbSettingIcon";
