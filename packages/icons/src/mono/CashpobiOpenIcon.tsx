...
export interface CashpobiOpenIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiOpenIcon = React.forwardRef<SVGSVGElement, CashpobiOpenIconProps>(
...
CashpobiOpenIcon.displayName = "CashpobiOpenIcon";
