...
export interface CashwalkBizCalendarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizCalendarIcon = React.forwardRef<SVGSVGElement, CashwalkBizCalendarIconProps>(
...
CashwalkBizCalendarIcon.displayName = "CashwalkBizCalendarIcon";
