...
export interface CashwalkBizCheckCircleOffIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizCheckCircleOffIcon = React.forwardRef<SVGSVGElement, CashwalkBizCheckCircleOffIconProps>(
  ({ size = 24, color = "currentColor", ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <g transform="scale(1.249987 1.249987)">
<g id="Group 31">
...
CashwalkBizCheckCircleOffIcon.displayName = "CashwalkBizCheckCircleOffIcon";
