...
export interface CashwalkBizCheckIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizCheckIcon = React.forwardRef<SVGSVGElement, CashwalkBizCheckIconProps>(
...
CashwalkBizCheckIcon.displayName = "CashwalkBizCheckIcon";
