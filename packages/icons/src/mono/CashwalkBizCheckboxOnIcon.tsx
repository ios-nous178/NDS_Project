...
export interface CashwalkBizCheckboxOnIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizCheckboxOnIcon = React.forwardRef<SVGSVGElement, CashwalkBizCheckboxOnIconProps>(
...
CashwalkBizCheckboxOnIcon.displayName = "CashwalkBizCheckboxOnIcon";
