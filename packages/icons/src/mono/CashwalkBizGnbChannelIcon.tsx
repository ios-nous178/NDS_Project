...
export interface CashwalkBizGnbChannelIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizGnbChannelIcon = React.forwardRef<SVGSVGElement, CashwalkBizGnbChannelIconProps>(
...
CashwalkBizGnbChannelIcon.displayName = "CashwalkBizGnbChannelIcon";
