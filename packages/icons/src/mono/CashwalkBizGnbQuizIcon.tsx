...
export interface CashwalkBizGnbQuizIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizGnbQuizIcon = React.forwardRef<SVGSVGElement, CashwalkBizGnbQuizIconProps>(
...
CashwalkBizGnbQuizIcon.displayName = "CashwalkBizGnbQuizIcon";
