...
export interface CashwalkBizMessageQuizIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizMessageQuizIcon = React.forwardRef<SVGSVGElement, CashwalkBizMessageQuizIconProps>(
