...
export interface CashwalkBizQuestionIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkBizQuestionIcon = React.forwardRef<SVGSVGElement, CashwalkBizQuestionIconProps>(
...
CashwalkBizQuestionIcon.displayName = "CashwalkBizQuestionIcon";
