...
export interface CashwalkPinLineIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashwalkPinLineIcon = React.forwardRef<SVGSVGElement, CashwalkPinLineIconProps>(
...
CashwalkPinLineIcon.displayName = "CashwalkPinLineIcon";
