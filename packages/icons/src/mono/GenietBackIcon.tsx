...
export interface GenietBackIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietBackIcon = React.forwardRef<SVGSVGElement, GenietBackIconProps>(
...
GenietBackIcon.displayName = "GenietBackIcon";
