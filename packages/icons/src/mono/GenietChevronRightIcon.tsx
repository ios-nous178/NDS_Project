...
export interface GenietChevronRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietChevronRightIcon = React.forwardRef<SVGSVGElement, GenietChevronRightIconProps>(
...
GenietChevronRightIcon.displayName = "GenietChevronRightIcon";
