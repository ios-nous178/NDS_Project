...
export interface GenietChevronUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietChevronUpIcon = React.forwardRef<SVGSVGElement, GenietChevronUpIconProps>(
...
GenietChevronUpIcon.displayName = "GenietChevronUpIcon";
