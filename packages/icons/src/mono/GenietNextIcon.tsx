...
export interface GenietNextIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GenietNextIcon = React.forwardRef<SVGSVGElement, GenietNextIconProps>(
...
GenietNextIcon.displayName = "GenietNextIcon";
