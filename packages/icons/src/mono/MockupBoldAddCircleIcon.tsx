...
export interface MockupBoldAddCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAddCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldAddCircleIconProps>(
...
MockupBoldAddCircleIcon.displayName = "MockupBoldAddCircleIcon";
