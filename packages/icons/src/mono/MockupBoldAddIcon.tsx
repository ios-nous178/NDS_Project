...
export interface MockupBoldAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAddIcon = React.forwardRef<SVGSVGElement, MockupBoldAddIconProps>(
...
MockupBoldAddIcon.displayName = "MockupBoldAddIcon";
