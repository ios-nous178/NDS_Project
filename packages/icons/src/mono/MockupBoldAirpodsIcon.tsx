...
export interface MockupBoldAirpodsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAirpodsIcon = React.forwardRef<SVGSVGElement, MockupBoldAirpodsIconProps>(
