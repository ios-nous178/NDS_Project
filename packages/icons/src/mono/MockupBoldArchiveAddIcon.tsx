...
export interface MockupBoldArchiveAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArchiveAddIcon = React.forwardRef<SVGSVGElement, MockupBoldArchiveAddIconProps>(
...
MockupBoldArchiveAddIcon.displayName = "MockupBoldArchiveAddIcon";
