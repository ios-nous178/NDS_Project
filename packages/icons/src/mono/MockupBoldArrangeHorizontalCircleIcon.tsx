...
export interface MockupBoldArrangeHorizontalCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrangeHorizontalCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldArrangeHorizontalCircleIconProps>(
...
MockupBoldArrangeHorizontalCircleIcon.displayName = "MockupBoldArrangeHorizontalCircleIcon";
