...
export interface MockupBoldArrangeHorizontalSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrangeHorizontalSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldArrangeHorizontalSquareIconProps>(
...
MockupBoldArrangeHorizontalSquareIcon.displayName = "MockupBoldArrangeHorizontalSquareIcon";
