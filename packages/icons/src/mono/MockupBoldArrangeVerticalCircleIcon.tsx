...
export interface MockupBoldArrangeVerticalCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrangeVerticalCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldArrangeVerticalCircleIconProps>(
...
MockupBoldArrangeVerticalCircleIcon.displayName = "MockupBoldArrangeVerticalCircleIcon";
