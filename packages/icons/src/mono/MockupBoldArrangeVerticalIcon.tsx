...
export interface MockupBoldArrangeVerticalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrangeVerticalIcon = React.forwardRef<SVGSVGElement, MockupBoldArrangeVerticalIconProps>(
