...
export interface MockupBoldArrowRotateLeftIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowRotateLeftIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowRotateLeftIconProps>(
...
MockupBoldArrowRotateLeftIcon.displayName = "MockupBoldArrowRotateLeftIcon";
