...
export interface MockupBoldArrowRotateRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowRotateRightIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowRotateRightIconProps>(
...
MockupBoldArrowRotateRightIcon.displayName = "MockupBoldArrowRotateRightIcon";
