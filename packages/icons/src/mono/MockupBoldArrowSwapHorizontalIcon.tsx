...
export interface MockupBoldArrowSwapHorizontalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowSwapHorizontalIcon = React.forwardRef<SVGSVGElement, MockupBoldArrowSwapHorizontalIconProps>(
...
MockupBoldArrowSwapHorizontalIcon.displayName = "MockupBoldArrowSwapHorizontalIcon";
