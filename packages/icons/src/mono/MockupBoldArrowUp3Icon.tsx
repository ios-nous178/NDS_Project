...
export interface MockupBoldArrowUp3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldArrowUp3Icon = React.forwardRef<SVGSVGElement, MockupBoldArrowUp3IconProps>(
...
MockupBoldArrowUp3Icon.displayName = "MockupBoldArrowUp3Icon";
