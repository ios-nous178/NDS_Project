...
export interface MockupBoldAttachSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldAttachSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldAttachSquareIconProps>(
