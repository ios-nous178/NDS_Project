...
export interface MockupBoldBackSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBackSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldBackSquareIconProps>(
...
MockupBoldBackSquareIcon.displayName = "MockupBoldBackSquareIcon";
