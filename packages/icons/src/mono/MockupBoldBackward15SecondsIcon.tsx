...
export interface MockupBoldBackward15SecondsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBackward15SecondsIcon = React.forwardRef<SVGSVGElement, MockupBoldBackward15SecondsIconProps>(
