...
export interface MockupBoldBagCrossIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBagCrossIcon = React.forwardRef<SVGSVGElement, MockupBoldBagCrossIconProps>(
