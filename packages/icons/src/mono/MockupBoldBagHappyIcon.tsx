...
export interface MockupBoldBagHappyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBagHappyIcon = React.forwardRef<SVGSVGElement, MockupBoldBagHappyIconProps>(
