...
export interface MockupBoldBagIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBagIcon = React.forwardRef<SVGSVGElement, MockupBoldBagIconProps>(
