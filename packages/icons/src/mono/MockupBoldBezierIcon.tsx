...
export interface MockupBoldBezierIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBezierIcon = React.forwardRef<SVGSVGElement, MockupBoldBezierIconProps>(
