...
export interface MockupBoldBookIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBookIcon = React.forwardRef<SVGSVGElement, MockupBoldBookIconProps>(
...
MockupBoldBookIcon.displayName = "MockupBoldBookIcon";
