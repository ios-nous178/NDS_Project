...
export interface MockupBoldBox2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBox2Icon = React.forwardRef<SVGSVGElement, MockupBoldBox2IconProps>(
