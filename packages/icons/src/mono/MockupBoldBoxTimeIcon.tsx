...
export interface MockupBoldBoxTimeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBoxTimeIcon = React.forwardRef<SVGSVGElement, MockupBoldBoxTimeIconProps>(
