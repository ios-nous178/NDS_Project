...
export interface MockupBoldBrodcastIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBrodcastIcon = React.forwardRef<SVGSVGElement, MockupBoldBrodcastIconProps>(
