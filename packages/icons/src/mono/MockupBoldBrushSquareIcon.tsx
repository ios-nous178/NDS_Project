...
export interface MockupBoldBrushSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBrushSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldBrushSquareIconProps>(
