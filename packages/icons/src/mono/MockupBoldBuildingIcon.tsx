...
export interface MockupBoldBuildingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldBuildingIcon = React.forwardRef<SVGSVGElement, MockupBoldBuildingIconProps>(
