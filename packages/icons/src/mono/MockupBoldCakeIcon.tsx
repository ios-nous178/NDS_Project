...
export interface MockupBoldCakeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCakeIcon = React.forwardRef<SVGSVGElement, MockupBoldCakeIconProps>(
