...
export interface MockupBoldCalendar2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCalendar2Icon = React.forwardRef<SVGSVGElement, MockupBoldCalendar2IconProps>(
...
MockupBoldCalendar2Icon.displayName = "MockupBoldCalendar2Icon";
