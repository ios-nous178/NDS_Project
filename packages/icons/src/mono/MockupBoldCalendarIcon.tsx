...
export interface MockupBoldCalendarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCalendarIcon = React.forwardRef<SVGSVGElement, MockupBoldCalendarIconProps>(
