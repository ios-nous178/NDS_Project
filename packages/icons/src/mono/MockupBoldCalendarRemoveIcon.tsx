...
export interface MockupBoldCalendarRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCalendarRemoveIcon = React.forwardRef<SVGSVGElement, MockupBoldCalendarRemoveIconProps>(
