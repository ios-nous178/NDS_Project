...
export interface MockupBoldCandle2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCandle2Icon = React.forwardRef<SVGSVGElement, MockupBoldCandle2IconProps>(
...
MockupBoldCandle2Icon.displayName = "MockupBoldCandle2Icon";
