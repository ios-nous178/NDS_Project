...
export interface MockupBoldCarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCarIcon = React.forwardRef<SVGSVGElement, MockupBoldCarIconProps>(
...
MockupBoldCarIcon.displayName = "MockupBoldCarIcon";
