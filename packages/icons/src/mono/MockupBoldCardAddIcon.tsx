...
export interface MockupBoldCardAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCardAddIcon = React.forwardRef<SVGSVGElement, MockupBoldCardAddIconProps>(
