...
export interface MockupBoldCardEditIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCardEditIcon = React.forwardRef<SVGSVGElement, MockupBoldCardEditIconProps>(
