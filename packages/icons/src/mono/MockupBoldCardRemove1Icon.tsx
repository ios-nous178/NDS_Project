...
export interface MockupBoldCardRemove1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCardRemove1Icon = React.forwardRef<SVGSVGElement, MockupBoldCardRemove1IconProps>(
