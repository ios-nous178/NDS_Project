...
export interface MockupBoldChartSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldChartSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldChartSquareIconProps>(
