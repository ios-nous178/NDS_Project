...
export interface MockupBoldClockIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldClockIcon = React.forwardRef<SVGSVGElement, MockupBoldClockIconProps>(
...
MockupBoldClockIcon.displayName = "MockupBoldClockIcon";
