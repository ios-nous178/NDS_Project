...
export interface MockupBoldCloseSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCloseSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldCloseSquareIconProps>(
...
MockupBoldCloseSquareIcon.displayName = "MockupBoldCloseSquareIcon";
