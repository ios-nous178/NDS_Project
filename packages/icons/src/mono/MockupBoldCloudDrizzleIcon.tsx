...
export interface MockupBoldCloudDrizzleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCloudDrizzleIcon = React.forwardRef<SVGSVGElement, MockupBoldCloudDrizzleIconProps>(
