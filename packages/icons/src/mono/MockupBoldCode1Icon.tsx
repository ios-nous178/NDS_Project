...
export interface MockupBoldCode1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCode1Icon = React.forwardRef<SVGSVGElement, MockupBoldCode1IconProps>(
...
MockupBoldCode1Icon.displayName = "MockupBoldCode1Icon";
