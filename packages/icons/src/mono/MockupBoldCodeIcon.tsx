...
export interface MockupBoldCodeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCodeIcon = React.forwardRef<SVGSVGElement, MockupBoldCodeIconProps>(
