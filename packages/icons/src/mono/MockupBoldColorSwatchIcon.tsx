...
export interface MockupBoldColorSwatchIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldColorSwatchIcon = React.forwardRef<SVGSVGElement, MockupBoldColorSwatchIconProps>(
