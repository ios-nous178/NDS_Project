...
export interface MockupBoldColorsSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldColorsSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldColorsSquareIconProps>(
