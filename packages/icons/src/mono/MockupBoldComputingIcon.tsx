...
export interface MockupBoldComputingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldComputingIcon = React.forwardRef<SVGSVGElement, MockupBoldComputingIconProps>(
...
MockupBoldComputingIcon.displayName = "MockupBoldComputingIcon";
