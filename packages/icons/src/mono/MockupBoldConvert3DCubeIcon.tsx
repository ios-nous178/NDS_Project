...
export interface MockupBoldConvert3DCubeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldConvert3DCubeIcon = React.forwardRef<SVGSVGElement, MockupBoldConvert3DCubeIconProps>(
