...
export interface MockupBoldConvertshapeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldConvertshapeIcon = React.forwardRef<SVGSVGElement, MockupBoldConvertshapeIconProps>(
...
MockupBoldConvertshapeIcon.displayName = "MockupBoldConvertshapeIcon";
