...
export interface MockupBoldCpuSettingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCpuSettingIcon = React.forwardRef<SVGSVGElement, MockupBoldCpuSettingIconProps>(
