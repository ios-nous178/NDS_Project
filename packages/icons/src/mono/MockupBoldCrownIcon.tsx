...
export interface MockupBoldCrownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldCrownIcon = React.forwardRef<SVGSVGElement, MockupBoldCrownIconProps>(
...
MockupBoldCrownIcon.displayName = "MockupBoldCrownIcon";
