...
export interface MockupBoldDirectboxReceiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDirectboxReceiveIcon = React.forwardRef<SVGSVGElement, MockupBoldDirectboxReceiveIconProps>(
