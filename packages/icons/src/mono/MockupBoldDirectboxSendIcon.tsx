...
export interface MockupBoldDirectboxSendIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDirectboxSendIcon = React.forwardRef<SVGSVGElement, MockupBoldDirectboxSendIconProps>(
