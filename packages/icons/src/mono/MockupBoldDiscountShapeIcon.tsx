...
export interface MockupBoldDiscountShapeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDiscountShapeIcon = React.forwardRef<SVGSVGElement, MockupBoldDiscountShapeIconProps>(
...
MockupBoldDiscountShapeIcon.displayName = "MockupBoldDiscountShapeIcon";
