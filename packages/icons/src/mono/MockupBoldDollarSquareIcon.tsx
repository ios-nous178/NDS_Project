...
export interface MockupBoldDollarSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDollarSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldDollarSquareIconProps>(
