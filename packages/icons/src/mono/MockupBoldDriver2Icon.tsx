...
export interface MockupBoldDriver2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldDriver2Icon = React.forwardRef<SVGSVGElement, MockupBoldDriver2IconProps>(
