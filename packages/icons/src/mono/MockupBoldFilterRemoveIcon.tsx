...
export interface MockupBoldFilterRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFilterRemoveIcon = React.forwardRef<SVGSVGElement, MockupBoldFilterRemoveIconProps>(
