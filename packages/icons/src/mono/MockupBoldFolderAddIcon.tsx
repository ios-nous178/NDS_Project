...
export interface MockupBoldFolderAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldFolderAddIcon = React.forwardRef<SVGSVGElement, MockupBoldFolderAddIconProps>(
...
MockupBoldFolderAddIcon.displayName = "MockupBoldFolderAddIcon";
