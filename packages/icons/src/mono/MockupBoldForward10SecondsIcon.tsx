...
export interface MockupBoldForward10SecondsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldForward10SecondsIcon = React.forwardRef<SVGSVGElement, MockupBoldForward10SecondsIconProps>(
