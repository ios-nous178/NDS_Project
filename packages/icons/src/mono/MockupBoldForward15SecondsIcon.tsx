...
export interface MockupBoldForward15SecondsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldForward15SecondsIcon = React.forwardRef<SVGSVGElement, MockupBoldForward15SecondsIconProps>(
