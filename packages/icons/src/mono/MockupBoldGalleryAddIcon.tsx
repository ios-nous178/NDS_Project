...
export interface MockupBoldGalleryAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGalleryAddIcon = React.forwardRef<SVGSVGElement, MockupBoldGalleryAddIconProps>(
