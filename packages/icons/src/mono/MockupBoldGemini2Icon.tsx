...
export interface MockupBoldGemini2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGemini2Icon = React.forwardRef<SVGSVGElement, MockupBoldGemini2IconProps>(
