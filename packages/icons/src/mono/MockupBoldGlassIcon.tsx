...
export interface MockupBoldGlassIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGlassIcon = React.forwardRef<SVGSVGElement, MockupBoldGlassIconProps>(
