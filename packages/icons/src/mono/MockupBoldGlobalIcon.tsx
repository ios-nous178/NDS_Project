...
export interface MockupBoldGlobalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGlobalIcon = React.forwardRef<SVGSVGElement, MockupBoldGlobalIconProps>(
