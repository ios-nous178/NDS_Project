...
export interface MockupBoldGpsSlashIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGpsSlashIcon = React.forwardRef<SVGSVGElement, MockupBoldGpsSlashIconProps>(
...
MockupBoldGpsSlashIcon.displayName = "MockupBoldGpsSlashIcon";
