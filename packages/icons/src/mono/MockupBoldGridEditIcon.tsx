...
export interface MockupBoldGridEditIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGridEditIcon = React.forwardRef<SVGSVGElement, MockupBoldGridEditIconProps>(
...
MockupBoldGridEditIcon.displayName = "MockupBoldGridEditIcon";
