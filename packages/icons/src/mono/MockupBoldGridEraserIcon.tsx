...
export interface MockupBoldGridEraserIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldGridEraserIcon = React.forwardRef<SVGSVGElement, MockupBoldGridEraserIconProps>(
