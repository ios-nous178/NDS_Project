...
export interface MockupBoldHashtagUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHashtagUpIcon = React.forwardRef<SVGSVGElement, MockupBoldHashtagUpIconProps>(
