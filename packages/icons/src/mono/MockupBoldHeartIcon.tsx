...
export interface MockupBoldHeartIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHeartIcon = React.forwardRef<SVGSVGElement, MockupBoldHeartIconProps>(
...
MockupBoldHeartIcon.displayName = "MockupBoldHeartIcon";
