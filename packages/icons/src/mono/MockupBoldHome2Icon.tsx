...
export interface MockupBoldHome2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHome2Icon = React.forwardRef<SVGSVGElement, MockupBoldHome2IconProps>(
...
MockupBoldHome2Icon.displayName = "MockupBoldHome2Icon";
