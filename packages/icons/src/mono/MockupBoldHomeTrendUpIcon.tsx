...
export interface MockupBoldHomeTrendUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldHomeTrendUpIcon = React.forwardRef<SVGSVGElement, MockupBoldHomeTrendUpIconProps>(
