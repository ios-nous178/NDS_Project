...
export interface MockupBoldImportSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldImportSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldImportSquareIconProps>(
...
MockupBoldImportSquareIcon.displayName = "MockupBoldImportSquareIcon";
