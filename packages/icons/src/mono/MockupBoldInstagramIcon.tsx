...
export interface MockupBoldInstagramIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldInstagramIcon = React.forwardRef<SVGSVGElement, MockupBoldInstagramIconProps>(
...
MockupBoldInstagramIcon.displayName = "MockupBoldInstagramIcon";
