...
export interface MockupBoldLampSlashIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLampSlashIcon = React.forwardRef<SVGSVGElement, MockupBoldLampSlashIconProps>(
