...
export interface MockupBoldLanguageSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLanguageSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldLanguageSquareIconProps>(
...
MockupBoldLanguageSquareIcon.displayName = "MockupBoldLanguageSquareIcon";
