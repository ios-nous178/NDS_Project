...
export interface MockupBoldLayoutMaximizeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLayoutMaximizeIcon = React.forwardRef<SVGSVGElement, MockupBoldLayoutMaximizeIconProps>(
