...
export interface MockupBoldLikeShapesIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLikeShapesIcon = React.forwardRef<SVGSVGElement, MockupBoldLikeShapesIconProps>(
