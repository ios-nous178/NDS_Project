...
export interface MockupBoldLinkCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLinkCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldLinkCircleIconProps>(
