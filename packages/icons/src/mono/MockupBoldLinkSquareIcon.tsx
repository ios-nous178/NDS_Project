...
export interface MockupBoldLinkSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLinkSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldLinkSquareIconProps>(
