...
export interface MockupBoldLocationAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLocationAddIcon = React.forwardRef<SVGSVGElement, MockupBoldLocationAddIconProps>(
...
MockupBoldLocationAddIcon.displayName = "MockupBoldLocationAddIcon";
