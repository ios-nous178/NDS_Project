...
export interface MockupBoldLocationCrossIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLocationCrossIcon = React.forwardRef<SVGSVGElement, MockupBoldLocationCrossIconProps>(
...
MockupBoldLocationCrossIcon.displayName = "MockupBoldLocationCrossIcon";
