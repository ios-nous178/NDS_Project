...
export interface MockupBoldLocationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldLocationIcon = React.forwardRef<SVGSVGElement, MockupBoldLocationIconProps>(
...
MockupBoldLocationIcon.displayName = "MockupBoldLocationIcon";
