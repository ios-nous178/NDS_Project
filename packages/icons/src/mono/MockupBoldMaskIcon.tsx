...
export interface MockupBoldMaskIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaskIcon = React.forwardRef<SVGSVGElement, MockupBoldMaskIconProps>(
