...
export interface MockupBoldMaximize1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaximize1Icon = React.forwardRef<SVGSVGElement, MockupBoldMaximize1IconProps>(
