...
export interface MockupBoldMaximize2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaximize2Icon = React.forwardRef<SVGSVGElement, MockupBoldMaximize2IconProps>(
