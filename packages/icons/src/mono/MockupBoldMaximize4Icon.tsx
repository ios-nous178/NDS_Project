...
export interface MockupBoldMaximize4IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaximize4Icon = React.forwardRef<SVGSVGElement, MockupBoldMaximize4IconProps>(
...
MockupBoldMaximize4Icon.displayName = "MockupBoldMaximize4Icon";
