...
export interface MockupBoldMaximizeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMaximizeIcon = React.forwardRef<SVGSVGElement, MockupBoldMaximizeIconProps>(
...
MockupBoldMaximizeIcon.displayName = "MockupBoldMaximizeIcon";
