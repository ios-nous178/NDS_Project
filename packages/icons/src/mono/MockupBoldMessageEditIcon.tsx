...
export interface MockupBoldMessageEditIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMessageEditIcon = React.forwardRef<SVGSVGElement, MockupBoldMessageEditIconProps>(
