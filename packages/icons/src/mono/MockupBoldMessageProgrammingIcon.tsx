...
export interface MockupBoldMessageProgrammingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMessageProgrammingIcon = React.forwardRef<SVGSVGElement, MockupBoldMessageProgrammingIconProps>(
