...
export interface MockupBoldMessages1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMessages1Icon = React.forwardRef<SVGSVGElement, MockupBoldMessages1IconProps>(
