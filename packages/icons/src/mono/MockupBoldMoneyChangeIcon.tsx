...
export interface MockupBoldMoneyChangeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMoneyChangeIcon = React.forwardRef<SVGSVGElement, MockupBoldMoneyChangeIconProps>(
