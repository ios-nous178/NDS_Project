...
export interface MockupBoldMoneySendIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMoneySendIcon = React.forwardRef<SVGSVGElement, MockupBoldMoneySendIconProps>(
