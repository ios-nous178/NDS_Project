...
export interface MockupBoldMusicSquareAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldMusicSquareAddIcon = React.forwardRef<SVGSVGElement, MockupBoldMusicSquareAddIconProps>(
