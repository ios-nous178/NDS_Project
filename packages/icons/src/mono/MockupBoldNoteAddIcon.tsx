...
export interface MockupBoldNoteAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldNoteAddIcon = React.forwardRef<SVGSVGElement, MockupBoldNoteAddIconProps>(
...
MockupBoldNoteAddIcon.displayName = "MockupBoldNoteAddIcon";
