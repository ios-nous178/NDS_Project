...
export interface MockupBoldNotificationBingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldNotificationBingIcon = React.forwardRef<SVGSVGElement, MockupBoldNotificationBingIconProps>(
...
MockupBoldNotificationBingIcon.displayName = "MockupBoldNotificationBingIcon";
