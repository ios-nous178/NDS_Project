...
export interface MockupBoldNotificationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldNotificationIcon = React.forwardRef<SVGSVGElement, MockupBoldNotificationIconProps>(
...
MockupBoldNotificationIcon.displayName = "MockupBoldNotificationIcon";
