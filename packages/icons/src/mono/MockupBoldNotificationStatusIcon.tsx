...
export interface MockupBoldNotificationStatusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldNotificationStatusIcon = React.forwardRef<SVGSVGElement, MockupBoldNotificationStatusIconProps>(
