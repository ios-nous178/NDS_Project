...
export interface MockupBoldOmegaSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldOmegaSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldOmegaSquareIconProps>(
...
MockupBoldOmegaSquareIcon.displayName = "MockupBoldOmegaSquareIcon";
