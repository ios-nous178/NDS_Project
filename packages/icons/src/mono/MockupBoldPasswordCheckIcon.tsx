...
export interface MockupBoldPasswordCheckIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPasswordCheckIcon = React.forwardRef<SVGSVGElement, MockupBoldPasswordCheckIconProps>(
...
MockupBoldPasswordCheckIcon.displayName = "MockupBoldPasswordCheckIcon";
