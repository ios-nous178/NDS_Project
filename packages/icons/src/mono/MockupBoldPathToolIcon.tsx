...
export interface MockupBoldPathToolIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPathToolIcon = React.forwardRef<SVGSVGElement, MockupBoldPathToolIconProps>(
