...
export interface MockupBoldPrinterIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldPrinterIcon = React.forwardRef<SVGSVGElement, MockupBoldPrinterIconProps>(
