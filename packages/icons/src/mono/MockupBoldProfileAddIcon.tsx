...
export interface MockupBoldProfileAddIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldProfileAddIcon = React.forwardRef<SVGSVGElement, MockupBoldProfileAddIconProps>(
...
MockupBoldProfileAddIcon.displayName = "MockupBoldProfileAddIcon";
