...
export interface MockupBoldProfileIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldProfileIcon = React.forwardRef<SVGSVGElement, MockupBoldProfileIconProps>(
...
MockupBoldProfileIcon.displayName = "MockupBoldProfileIcon";
