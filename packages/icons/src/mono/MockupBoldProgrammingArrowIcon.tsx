...
export interface MockupBoldProgrammingArrowIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldProgrammingArrowIcon = React.forwardRef<SVGSVGElement, MockupBoldProgrammingArrowIconProps>(
...
MockupBoldProgrammingArrowIcon.displayName = "MockupBoldProgrammingArrowIcon";
