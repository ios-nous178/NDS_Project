...
export interface MockupBoldReceiveSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldReceiveSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldReceiveSquareIconProps>(
...
MockupBoldReceiveSquareIcon.displayName = "MockupBoldReceiveSquareIcon";
