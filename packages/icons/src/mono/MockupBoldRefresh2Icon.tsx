...
export interface MockupBoldRefresh2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRefresh2Icon = React.forwardRef<SVGSVGElement, MockupBoldRefresh2IconProps>(
