...
export interface MockupBoldRepeateMusicIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRepeateMusicIcon = React.forwardRef<SVGSVGElement, MockupBoldRepeateMusicIconProps>(
