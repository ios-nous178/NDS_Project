...
export interface MockupBoldRotateLeftIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRotateLeftIcon = React.forwardRef<SVGSVGElement, MockupBoldRotateLeftIconProps>(
...
MockupBoldRotateLeftIcon.displayName = "MockupBoldRotateLeftIcon";
