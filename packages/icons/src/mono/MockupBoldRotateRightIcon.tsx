...
export interface MockupBoldRotateRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRotateRightIcon = React.forwardRef<SVGSVGElement, MockupBoldRotateRightIconProps>(
...
MockupBoldRotateRightIcon.displayName = "MockupBoldRotateRightIcon";
