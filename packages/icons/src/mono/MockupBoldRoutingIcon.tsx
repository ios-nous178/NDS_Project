...
export interface MockupBoldRoutingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRoutingIcon = React.forwardRef<SVGSVGElement, MockupBoldRoutingIconProps>(
...
MockupBoldRoutingIcon.displayName = "MockupBoldRoutingIcon";
