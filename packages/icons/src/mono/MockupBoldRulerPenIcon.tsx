...
export interface MockupBoldRulerPenIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldRulerPenIcon = React.forwardRef<SVGSVGElement, MockupBoldRulerPenIconProps>(
