...
export interface MockupBoldScanBarcodeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldScanBarcodeIcon = React.forwardRef<SVGSVGElement, MockupBoldScanBarcodeIconProps>(
