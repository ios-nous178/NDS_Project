...
export interface MockupBoldSecurityUserIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSecurityUserIcon = React.forwardRef<SVGSVGElement, MockupBoldSecurityUserIconProps>(
