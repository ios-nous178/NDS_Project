...
export interface MockupBoldSetting2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSetting2Icon = React.forwardRef<SVGSVGElement, MockupBoldSetting2IconProps>(
...
MockupBoldSetting2Icon.displayName = "MockupBoldSetting2Icon";
