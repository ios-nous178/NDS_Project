...
export interface MockupBoldSetting3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSetting3Icon = React.forwardRef<SVGSVGElement, MockupBoldSetting3IconProps>(
