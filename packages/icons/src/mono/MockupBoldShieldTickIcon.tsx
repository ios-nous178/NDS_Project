...
export interface MockupBoldShieldTickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldShieldTickIcon = React.forwardRef<SVGSVGElement, MockupBoldShieldTickIconProps>(
...
MockupBoldShieldTickIcon.displayName = "MockupBoldShieldTickIcon";
