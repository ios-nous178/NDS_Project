...
export interface MockupBoldShopIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldShopIcon = React.forwardRef<SVGSVGElement, MockupBoldShopIconProps>(
