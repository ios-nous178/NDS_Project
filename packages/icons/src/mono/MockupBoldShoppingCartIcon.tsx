...
export interface MockupBoldShoppingCartIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldShoppingCartIcon = React.forwardRef<SVGSVGElement, MockupBoldShoppingCartIconProps>(
...
MockupBoldShoppingCartIcon.displayName = "MockupBoldShoppingCartIcon";
