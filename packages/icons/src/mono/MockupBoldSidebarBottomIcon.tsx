...
export interface MockupBoldSidebarBottomIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSidebarBottomIcon = React.forwardRef<SVGSVGElement, MockupBoldSidebarBottomIconProps>(
...
MockupBoldSidebarBottomIcon.displayName = "MockupBoldSidebarBottomIcon";
