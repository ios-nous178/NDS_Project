...
export interface MockupBoldSmallcapsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSmallcapsIcon = React.forwardRef<SVGSVGElement, MockupBoldSmallcapsIconProps>(
