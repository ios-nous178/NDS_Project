...
export interface MockupBoldSmartHomeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldSmartHomeIcon = React.forwardRef<SVGSVGElement, MockupBoldSmartHomeIconProps>(
