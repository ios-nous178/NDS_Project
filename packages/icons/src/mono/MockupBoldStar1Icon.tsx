...
export interface MockupBoldStar1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldStar1Icon = React.forwardRef<SVGSVGElement, MockupBoldStar1IconProps>(
...
MockupBoldStar1Icon.displayName = "MockupBoldStar1Icon";
