...
export interface MockupBoldStarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldStarIcon = React.forwardRef<SVGSVGElement, MockupBoldStarIconProps>(
...
MockupBoldStarIcon.displayName = "MockupBoldStarIcon";
