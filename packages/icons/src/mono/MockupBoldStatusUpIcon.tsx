...
export interface MockupBoldStatusUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldStatusUpIcon = React.forwardRef<SVGSVGElement, MockupBoldStatusUpIconProps>(
...
MockupBoldStatusUpIcon.displayName = "MockupBoldStatusUpIcon";
