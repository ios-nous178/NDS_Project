...
export interface MockupBoldStoryIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldStoryIcon = React.forwardRef<SVGSVGElement, MockupBoldStoryIconProps>(
