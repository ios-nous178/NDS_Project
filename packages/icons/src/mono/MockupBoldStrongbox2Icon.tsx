...
export interface MockupBoldStrongbox2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldStrongbox2Icon = React.forwardRef<SVGSVGElement, MockupBoldStrongbox2IconProps>(
...
MockupBoldStrongbox2Icon.displayName = "MockupBoldStrongbox2Icon";
