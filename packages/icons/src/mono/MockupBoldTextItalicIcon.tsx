...
export interface MockupBoldTextItalicIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTextItalicIcon = React.forwardRef<SVGSVGElement, MockupBoldTextItalicIconProps>(
...
MockupBoldTextItalicIcon.displayName = "MockupBoldTextItalicIcon";
