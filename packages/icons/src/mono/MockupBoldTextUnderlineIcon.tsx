...
export interface MockupBoldTextUnderlineIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTextUnderlineIcon = React.forwardRef<SVGSVGElement, MockupBoldTextUnderlineIconProps>(
...
MockupBoldTextUnderlineIcon.displayName = "MockupBoldTextUnderlineIcon";
