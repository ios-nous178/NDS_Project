...
export interface MockupBoldTickCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTickCircleIcon = React.forwardRef<SVGSVGElement, MockupBoldTickCircleIconProps>(
...
MockupBoldTickCircleIcon.displayName = "MockupBoldTickCircleIcon";
