...
export interface MockupBoldTickSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTickSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldTickSquareIconProps>(
...
MockupBoldTickSquareIcon.displayName = "MockupBoldTickSquareIcon";
