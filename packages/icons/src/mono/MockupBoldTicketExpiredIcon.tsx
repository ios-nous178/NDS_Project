...
export interface MockupBoldTicketExpiredIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTicketExpiredIcon = React.forwardRef<SVGSVGElement, MockupBoldTicketExpiredIconProps>(
...
MockupBoldTicketExpiredIcon.displayName = "MockupBoldTicketExpiredIcon";
