...
export interface MockupBoldTicketIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTicketIcon = React.forwardRef<SVGSVGElement, MockupBoldTicketIconProps>(
