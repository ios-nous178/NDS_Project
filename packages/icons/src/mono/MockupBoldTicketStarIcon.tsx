...
export interface MockupBoldTicketStarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTicketStarIcon = React.forwardRef<SVGSVGElement, MockupBoldTicketStarIconProps>(
