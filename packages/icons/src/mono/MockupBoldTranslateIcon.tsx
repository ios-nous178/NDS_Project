...
export interface MockupBoldTranslateIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTranslateIcon = React.forwardRef<SVGSVGElement, MockupBoldTranslateIconProps>(
