...
export interface MockupBoldTrashIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTrashIcon = React.forwardRef<SVGSVGElement, MockupBoldTrashIconProps>(
...
MockupBoldTrashIcon.displayName = "MockupBoldTrashIcon";
