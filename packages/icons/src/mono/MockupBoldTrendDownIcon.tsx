...
export interface MockupBoldTrendDownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldTrendDownIcon = React.forwardRef<SVGSVGElement, MockupBoldTrendDownIconProps>(
...
MockupBoldTrendDownIcon.displayName = "MockupBoldTrendDownIcon";
