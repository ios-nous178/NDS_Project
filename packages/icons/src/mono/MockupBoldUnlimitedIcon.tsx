...
export interface MockupBoldUnlimitedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldUnlimitedIcon = React.forwardRef<SVGSVGElement, MockupBoldUnlimitedIconProps>(
