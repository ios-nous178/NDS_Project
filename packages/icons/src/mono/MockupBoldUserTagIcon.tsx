...
export interface MockupBoldUserTagIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldUserTagIcon = React.forwardRef<SVGSVGElement, MockupBoldUserTagIconProps>(
...
MockupBoldUserTagIcon.displayName = "MockupBoldUserTagIcon";
