...
export interface MockupBoldVideoTickIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVideoTickIcon = React.forwardRef<SVGSVGElement, MockupBoldVideoTickIconProps>(
...
MockupBoldVideoTickIcon.displayName = "MockupBoldVideoTickIcon";
