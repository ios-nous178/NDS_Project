...
export interface MockupBoldVideoVerticalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVideoVerticalIcon = React.forwardRef<SVGSVGElement, MockupBoldVideoVerticalIconProps>(
