...
export interface MockupBoldVoiceSquareIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVoiceSquareIcon = React.forwardRef<SVGSVGElement, MockupBoldVoiceSquareIconProps>(
...
MockupBoldVoiceSquareIcon.displayName = "MockupBoldVoiceSquareIcon";
