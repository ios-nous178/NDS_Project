...
export interface MockupBoldVolumeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldVolumeIcon = React.forwardRef<SVGSVGElement, MockupBoldVolumeIconProps>(
