...
export interface MockupBoldWalletAdd1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWalletAdd1Icon = React.forwardRef<SVGSVGElement, MockupBoldWalletAdd1IconProps>(
