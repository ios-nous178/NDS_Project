...
export interface MockupBoldWalletMinusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWalletMinusIcon = React.forwardRef<SVGSVGElement, MockupBoldWalletMinusIconProps>(
...
MockupBoldWalletMinusIcon.displayName = "MockupBoldWalletMinusIcon";
