...
export interface MockupBoldWatchStatusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWatchStatusIcon = React.forwardRef<SVGSVGElement, MockupBoldWatchStatusIconProps>(
...
MockupBoldWatchStatusIcon.displayName = "MockupBoldWatchStatusIcon";
