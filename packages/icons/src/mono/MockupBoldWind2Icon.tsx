...
export interface MockupBoldWind2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupBoldWind2Icon = React.forwardRef<SVGSVGElement, MockupBoldWind2IconProps>(
