...
export interface MockupLinearAutobrightnessIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearAutobrightnessIcon = React.forwardRef<SVGSVGElement, MockupLinearAutobrightnessIconProps>(
