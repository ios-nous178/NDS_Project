...
export interface MockupLinearBook1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearBook1Icon = React.forwardRef<SVGSVGElement, MockupLinearBook1IconProps>(
...
MockupLinearBook1Icon.displayName = "MockupLinearBook1Icon";
