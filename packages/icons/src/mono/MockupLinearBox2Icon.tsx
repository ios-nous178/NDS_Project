...
export interface MockupLinearBox2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearBox2Icon = React.forwardRef<SVGSVGElement, MockupLinearBox2IconProps>(
