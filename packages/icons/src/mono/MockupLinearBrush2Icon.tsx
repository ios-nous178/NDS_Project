...
export interface MockupLinearBrush2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearBrush2Icon = React.forwardRef<SVGSVGElement, MockupLinearBrush2IconProps>(
...
MockupLinearBrush2Icon.displayName = "MockupLinearBrush2Icon";
