...
export interface MockupLinearCalendarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCalendarIcon = React.forwardRef<SVGSVGElement, MockupLinearCalendarIconProps>(
...
MockupLinearCalendarIcon.displayName = "MockupLinearCalendarIcon";
