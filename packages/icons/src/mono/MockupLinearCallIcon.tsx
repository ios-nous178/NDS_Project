...
export interface MockupLinearCallIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearCallIcon = React.forwardRef<SVGSVGElement, MockupLinearCallIconProps>(
...
MockupLinearCallIcon.displayName = "MockupLinearCallIcon";
