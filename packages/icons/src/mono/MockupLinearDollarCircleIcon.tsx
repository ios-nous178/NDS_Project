...
export interface MockupLinearDollarCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearDollarCircleIcon = React.forwardRef<SVGSVGElement, MockupLinearDollarCircleIconProps>(
...
MockupLinearDollarCircleIcon.displayName = "MockupLinearDollarCircleIcon";
