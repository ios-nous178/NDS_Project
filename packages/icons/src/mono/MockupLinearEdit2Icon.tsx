...
export interface MockupLinearEdit2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearEdit2Icon = React.forwardRef<SVGSVGElement, MockupLinearEdit2IconProps>(
...
MockupLinearEdit2Icon.displayName = "MockupLinearEdit2Icon";
