...
export interface MockupLinearElementEqualIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearElementEqualIcon = React.forwardRef<SVGSVGElement, MockupLinearElementEqualIconProps>(
