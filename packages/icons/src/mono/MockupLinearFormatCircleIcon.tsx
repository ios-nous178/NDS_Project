...
export interface MockupLinearFormatCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearFormatCircleIcon = React.forwardRef<SVGSVGElement, MockupLinearFormatCircleIconProps>(
