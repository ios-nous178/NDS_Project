...
export interface MockupLinearIcon24SupportIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearIcon24SupportIcon = React.forwardRef<SVGSVGElement, MockupLinearIcon24SupportIconProps>(
...
MockupLinearIcon24SupportIcon.displayName = "MockupLinearIcon24SupportIcon";
