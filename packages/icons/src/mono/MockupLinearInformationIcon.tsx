...
export interface MockupLinearInformationIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearInformationIcon = React.forwardRef<SVGSVGElement, MockupLinearInformationIconProps>(
