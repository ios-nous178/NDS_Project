...
export interface MockupLinearLovelyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearLovelyIcon = React.forwardRef<SVGSVGElement, MockupLinearLovelyIconProps>(
...
MockupLinearLovelyIcon.displayName = "MockupLinearLovelyIcon";
