...
export interface MockupLinearMessageRemoveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearMessageRemoveIcon = React.forwardRef<SVGSVGElement, MockupLinearMessageRemoveIconProps>(
...
MockupLinearMessageRemoveIcon.displayName = "MockupLinearMessageRemoveIcon";
