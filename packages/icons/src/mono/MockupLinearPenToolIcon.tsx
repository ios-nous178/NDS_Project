...
export interface MockupLinearPenToolIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearPenToolIcon = React.forwardRef<SVGSVGElement, MockupLinearPenToolIconProps>(
