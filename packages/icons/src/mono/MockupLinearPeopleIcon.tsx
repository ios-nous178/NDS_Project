...
export interface MockupLinearPeopleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearPeopleIcon = React.forwardRef<SVGSVGElement, MockupLinearPeopleIconProps>(
...
MockupLinearPeopleIcon.displayName = "MockupLinearPeopleIcon";
