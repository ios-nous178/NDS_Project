...
export interface MockupLinearProfileCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearProfileCircleIcon = React.forwardRef<SVGSVGElement, MockupLinearProfileCircleIconProps>(
...
MockupLinearProfileCircleIcon.displayName = "MockupLinearProfileCircleIcon";
