...
export interface MockupLinearRankingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearRankingIcon = React.forwardRef<SVGSVGElement, MockupLinearRankingIconProps>(
...
MockupLinearRankingIcon.displayName = "MockupLinearRankingIcon";
