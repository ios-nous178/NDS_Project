...
export interface MockupLinearSave2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearSave2Icon = React.forwardRef<SVGSVGElement, MockupLinearSave2IconProps>(
