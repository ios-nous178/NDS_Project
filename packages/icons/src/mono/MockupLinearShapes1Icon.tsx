...
export interface MockupLinearShapes1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearShapes1Icon = React.forwardRef<SVGSVGElement, MockupLinearShapes1IconProps>(
...
MockupLinearShapes1Icon.displayName = "MockupLinearShapes1Icon";
