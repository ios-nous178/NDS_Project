...
export interface MockupLinearShopIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearShopIcon = React.forwardRef<SVGSVGElement, MockupLinearShopIconProps>(
