...
export interface MockupLinearStar1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MockupLinearStar1Icon = React.forwardRef<SVGSVGElement, MockupLinearStar1IconProps>(
...
MockupLinearStar1Icon.displayName = "MockupLinearStar1Icon";
