...
export interface RunmileChevronDownIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RunmileChevronDownIcon = React.forwardRef<SVGSVGElement, RunmileChevronDownIconProps>(
...
RunmileChevronDownIcon.displayName = "RunmileChevronDownIcon";
