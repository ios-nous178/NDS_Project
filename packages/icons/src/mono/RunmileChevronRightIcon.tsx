...
export interface RunmileChevronRightIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RunmileChevronRightIcon = React.forwardRef<SVGSVGElement, RunmileChevronRightIconProps>(
...
RunmileChevronRightIcon.displayName = "RunmileChevronRightIcon";
