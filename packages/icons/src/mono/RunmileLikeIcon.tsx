...
export interface RunmileLikeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RunmileLikeIcon = React.forwardRef<SVGSVGElement, RunmileLikeIconProps>(
