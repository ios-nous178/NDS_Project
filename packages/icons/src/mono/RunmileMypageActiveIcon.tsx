...
export interface RunmileMypageActiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RunmileMypageActiveIcon = React.forwardRef<SVGSVGElement, RunmileMypageActiveIconProps>(
...
RunmileMypageActiveIcon.displayName = "RunmileMypageActiveIcon";
