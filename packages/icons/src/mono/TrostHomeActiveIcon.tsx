...
export interface TrostHomeActiveIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const TrostHomeActiveIcon = React.forwardRef<SVGSVGElement, TrostHomeActiveIconProps>(
