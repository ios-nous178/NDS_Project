...
export interface TrostPlayIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const TrostPlayIcon = React.forwardRef<SVGSVGElement, TrostPlayIconProps>(
...
TrostPlayIcon.displayName = "TrostPlayIcon";
