...
export interface TrostSearchDeleteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const TrostSearchDeleteIcon = React.forwardRef<SVGSVGElement, TrostSearchDeleteIconProps>(
...
TrostSearchDeleteIcon.displayName = "TrostSearchDeleteIcon";
