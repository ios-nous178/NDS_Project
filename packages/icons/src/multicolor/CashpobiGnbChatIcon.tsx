...
export interface CashpobiGnbChatIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CashpobiGnbChatIcon = React.forwardRef<SVGSVGElement, CashpobiGnbChatIconProps>(
...
CashpobiGnbChatIcon.displayName = "CashpobiGnbChatIcon";
