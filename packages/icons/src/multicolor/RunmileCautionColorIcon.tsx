...
export interface RunmileCautionColorIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RunmileCautionColorIcon = React.forwardRef<SVGSVGElement, RunmileCautionColorIconProps>(
  ({ size = 24, color = "currentColor", ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <g transform="translate(1.9992 3)">
...
RunmileCautionColorIcon.displayName = "RunmileCautionColorIcon";
