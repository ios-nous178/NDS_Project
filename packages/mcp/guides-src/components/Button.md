...
sizeMatrix:
  ...
  sm: height 40 / px 16 / py 11 / 14·20 bold / icon 20 / gap 8 # 캐시워크 ButtonGuide S (구 42 → 공통 40)
  xs: height 36 / px 16 / py 10 / 13·18 bold / icon 18 / gap 6 # 캐시워크 ButtonGuide XS (구 38 → 공통 36)
stateMatrix:
