...
Trost(심리상담·멘탈케어 EAP) 웹 홈의 **시각 레퍼런스 카탈로그** — 사진 배경 다크 히어로 + 콘텐츠/칼럼 카드 그리드 구조의 데스크탑 홈 스크린샷을 담는다. Trost 웹은 **Zeplin 이 디자인 SSOT**(zpl.io/Dp775xl)이고, 블루 브랜드 컬러를 로고·CTA·링크·배너에만 쓴다. 화면을 새로 짤 때 **레이아웃·구성·위계의 출처**로 이 스크린샷을 먼저 보고(`references[].imageAbsolutePath`), 정확한 색·여백·치수·컴포넌트 선택은 Zeplin 과 브랜드 토큰을 SSOT 로 따른다.
