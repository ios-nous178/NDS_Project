...
export const COMPONENT_GUIDES: Record<string, ComponentGuide> = {
  ...
  "Badge": {
    ...
    "summary": "상태/속성을 한눈에 알려주는 보조 라벨. variant: fill/ghost/line · color: brand/neutral/success/error/caution/info · shape: default(라운드 사각)/pill(완전 둥근). Figma 171:10856 (캐포비 admin ChipGuide 3782-20558). label prop 필수. 콘텐츠가 아니라 콘텐츠를 보조하는 메타 정보만 담는다. **shape 로 의미 구분 — 동적 상태값=default(사각), 정적 식별 태그=pill.**",
    "pitfalls": [
