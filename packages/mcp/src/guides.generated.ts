...
export const COMPONENT_GUIDES: Record<string, ComponentGuide> = {
  ...
  "BottomSheet": {
    "name": "BottomSheet",
    "summary": "모바일에서 화면 하단에서 올라오는 시트. 옵션 선택 / 짧은 작업에 적합. 데스크탑에선 Drawer 가 자연스러움. 공유 시트는 이 컴포넌트로 4칸 그리드 + 링크 복사 레시피로 조립한다.",
    "pitfalls": [
