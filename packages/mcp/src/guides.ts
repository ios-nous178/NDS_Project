...
<Button rightIcon={<ArrowNextIcon />}>자세히 보기</Button>`,
  ...
  List: {
    name: "List",
    summary:
      "수직 정렬된 동질 항목의 컨테이너. <List variant='plain|card|divided'> + <ListItem leading title description trailing onSelect />. " +
...
/* ───────────── UX 라이팅 가이드 (Toss UX Writing 가이드 + EAP 도메인) ─────────────
 *
