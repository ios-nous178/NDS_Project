...
export const DESIGN_PRINCIPLES: DesignPrinciples = {
  ...
  donts: [
    ...
    "이모지 절대 사용 금지 — 어떤 위치에서도(라벨/버튼/제목/placeholder/empty state) 이모지를 텍스트로 박지 마세요. 아이콘이 필요하면 find_icon. validate_html_mockup 의 emoji-banned 룰로 자동 검출됨.",
...
export const ICON_METADATA: Record<string, IconMeta> = {
  ...
  GenietChevronUpIcon: { category: "navigation", style: "line" },
  GenietChevronRightIcon: { category: "navigation", style: "line" },
  ...
  RunmileAlarmActiveIcon: { category: "state-reaction", style: "filled" },
  RunmileAlarmIcon: { category: "state-reaction", style: "line" },
  RunmileAlarmOffIcon: { category: "state-reaction", style: "line" },
  RunmileChevronDownIcon: { category: "basic", style: "line" },
  RunmileChevronRightIcon: { category: "basic", style: "line" },
  RunmileChevronLeftIcon: { category: "basic", style: "line" },
  RunmileChevronUpIcon: { category: "basic", style: "line" },
  ...
  RunmileChatColorIcon: { category: "color", style: "color" },
  ...
  RunmileCheckCircleColorIcon: { category: "color", style: "color" },
  RunmileCheckCircleIcon: { category: "state-reaction", style: "filled" },
  RunmileWarningCircleIcon: { category: "state-reaction", style: "filled" },
  RunmileWarningCircleStrokeIcon: { category: "state-reaction", style: "line" },
  ...
  RunmileLocationIcon: { category: "location", style: "filled" },
  ...
  RunmileSearchDeleteIcon: { category: "state-reaction", style: "filled" },
