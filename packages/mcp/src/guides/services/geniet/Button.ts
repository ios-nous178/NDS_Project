 ...
 * Source: legacy COMPONENT_GUIDES.Button.brandMatrix.geniet (제거됨, 이쪽으로 마이그레이션) + Figma 207:1853.
 * 색 정보 ('secondary/solid 는 cobalt-50' 류) 는 토큰 SSOT (packages/tokens/src/brands/geniet.semantic.ts) 가 담당하므로 overlay 에서 제외.
 */
