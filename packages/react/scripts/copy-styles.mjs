#!/usr/bin/env node
/**
 * Copy @nudge-eap/styles' bundled CSS into this package so the legacy
 * `import "@nudge-eap/react/styles.css"` entry keeps working.
 *
 * The CSS pipeline (extract-styles.mjs) now lives in @nudge-eap/styles — see
...
if (!fs.existsSync(stylesSrc)) {
  console.error(
    `[@nudge-eap/react] @nudge-eap/styles bundled CSS not found at ${stylesSrc}. ` +
