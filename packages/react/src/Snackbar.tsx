...
const ManagedSnackbar: React.FC<{
  ...
  const icon =
    brand === "cashwalk-biz" && data.variant ? <SnackbarChipIcon variant={data.variant} /> : undefined;
...
interface SnackbarComponent
  extends React.ForwardRefExoticComponent<SnackbarProps & React.RefAttributes<HTMLDivElement>> {
