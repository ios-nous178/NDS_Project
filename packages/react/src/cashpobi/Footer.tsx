...
export type CashpobiFooterLayout = "desktop" | "mobile";

export interface CashpobiFooterProps {
  /**
   * Cashpobi 는 web 푸터만 제공 (app 환경 없음). surface 는 항상 'web'. brand 간 호출
   * 표면 통일을 위해 prop 만 노출 (타입 단에서 다른 값 차단).
   */
  surface?: "web";
  /** 반응형 레이아웃. */
  layout?: CashpobiFooterLayout;
  /** 약관/정책 링크. */
...
export const CashpobiFooter = React.forwardRef<HTMLElement, CashpobiFooterProps>(
...
CashpobiFooter.displayName = "CashpobiFooter";
