...
export const monepleTheme: BrandTheme = {
  ...
  typography: {
    ...
    typeScale: {
      ...
      headline3: { fontSize: 20, lineHeight: 28, letterSpacing: 0, fontWeight: 700 },
      ...
      body1: { fontSize: 16, lineHeight: 24, letterSpacing: 0, fontWeight: 500 },
      body2: { fontSize: 15, lineHeight: 22, letterSpacing: 0, fontWeight: 500 },
      ...
      caption2: { fontSize: 12, lineHeight: 16, letterSpacing: 0, fontWeight: 400 },
      label: { fontSize: 11, lineHeight: 14, letterSpacing: 0, fontWeight: 500 },
    },
  },
  spacing: {
    radius: {
