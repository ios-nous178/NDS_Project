...
export const cashwalkSemantic = {
  ...
  text: {
    ...
    disabled: { default: ref("color.neutral.500") }, // #BBBBBB — Text/Disabled (muted 와 동일)
    ...
    status: {
      ...
      error: ref("color.coralRed.500"), // #FF4141 — Text/Status/Error
  ...
  border: {
    ...
    status: {
      error: ref("color.coralRed.500"), // #FF4141 — base alias
  ...
  icon: {
    ...
    status: {
      ...
      error: ref("color.coralRed.500"), // #FF4141
  ...
  buttonBg: {
    ...
    disabled: ref("color.neutral.400"), // #DDDDDD — Solid/Primary Disabled
  ...
  buttonText: {
    default: ref("color.common.1000"), // #000000 — ButtonText/Default (노랑 위 검정)
    brand: ref("color.neutral.900"), // #111 — ButtonText/Outlined (Outlined/Primary 텍스트 = neutral/900 검정, 노랑 아님)
    ...
    neutral: ref("color.neutral.900"), // #111 — Weak/Outlined Neutral enabled 텍스트
    neutralSolid: ref("color.common.00"), // #FFFFFF — Solid Neutral 텍스트 (#111 검정 fill 위 흰)
    neutralDisabled: ref("color.neutral.500"), // #BBB — Neutral disabled 텍스트
    ...
    disabled: ref("color.common.00"), // #FFFFFF — ButtonText/Disabled
  },
  buttonBorder: {
    outlined: {
      default: ref("color.neutral.900"), // #111 — Outlined/Primary default border (neutral/900 검정)
      hover: ref("color.neutral.900"), // #111 — Outlined/Primary hover border (검정 유지, bg만 #FFFEF5 틴트)
      disabled: ref("color.neutral.300"), // #E7E7E7 — Outlined/Primary disabled border
    },
    neutral: {
  ...
  input: {
    ...
    borderError: ref("color.coralRed.500"), // #FF4141 — Input/Border/Error
    borderDisabled: ref("color.neutral.200"), // #EEEEEE — base alias
    placeholder: ref("color.neutral.500"), // #BBBBBB — Input/Placeholder
    // helpertext* — default = text.subtle(#666). (success/error/disabled 는 상태색 유지.)
    helpertextDefault: ref("color.neutral.700"), // #666666 — = text.subtle.default
    helpertextSuccess: ref("color.green.600"), // #00B350
    helpertextError: ref("color.coralRed.500"), // #FF4141
  ...
  confirmCta: {
    ...
    active: ref("color.neutral.800"), // #333333 — press
