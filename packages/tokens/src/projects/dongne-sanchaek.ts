/**
 * Dongne-sanchaek (동네산책) Brand Theme — cashwalk(캐시워크) accent 형제.
 *
 * cashwalk 구조·status·neutral CTA·input focus 를 그대로 상속하고 brand 색 슬롯만
 * **Indigo** accent 로 스왑한다(디자이너 결정 2026-06-21 "브랜드 색 전면 스왑").
 * 팔레트는 cashwalk 와 동일(Indigo 램프가 이미 cashwalk.palette 에 있음) — 재사용.
 *
...
export const dongneSanchaekSemantic = cashwalkAccentSemantic("indigo");

export const dongneSanchaekTheme: ProjectTheme = {
  name: "dongne-sanchaek",
  actionsLayout: "end",
