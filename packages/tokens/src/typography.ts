...
export const typeScale = {
  ...
  headline3: { fontSize: 26, lineHeight: 36, letterSpacing: 0 },
  headline4: { fontSize: 24, lineHeight: 32, letterSpacing: 0 },
  headline5: { fontSize: 20, lineHeight: 28, letterSpacing: 0 },
  headline6: { fontSize: 18, lineHeight: 26, letterSpacing: 0 },
